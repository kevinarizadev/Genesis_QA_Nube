(function () {
  ...
  angular.module('GenesisApp').directive('pre_validadorres202', pre_validadorres202);

  pre_validadorres202.$inject = ['$rootScope', '$compile'];
  function pre_validadorres202($rootScope, $compile) {
    return {
      restrict: 'EA',
