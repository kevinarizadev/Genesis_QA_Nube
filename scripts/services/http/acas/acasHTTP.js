    ...
    return ({
      obtenerArea: function(){
         var request = $http({
           ...
           data: {function: "mostrarArea"} //,
           //params: {identificacion:identificacion}
        });
           return (request.then(handleSuccessPost,handleError));
       },
        obtenerCriticidad: function(){
         var request = $http({
           method:'POST',
           url:"php/acas/mostrararea.php",
           data: { function: "mostrarCriticidad"}
        });
           return (request.then(handleSuccessPost,handleError));
       },
        ...
        obtenerPrioridad: function(documento,concepto, motivo,asunto,prioridad){
         var request = $http({
           method:'get',
           url:"php/acas/mostrarprioridad.php",
           params: {documento:documento, concepto:concepto,motivo:motivo,asunto:asunto,prioridad:prioridad}
        });
           return (request.then(handleSuccessPost,handleError));
       },
        ...
        insertarAcas: function(documento,ubicacion,concepto,motivo,ruta,observacion,emisor,asunto,criticidad,barrio,tipo_doc_apor,doc_aportante){
         var request = $http({
            
          method:'get',
          url:"php/acas/insertaracas.php",
          params: {documento:documento,ubicacion:ubicacion,concepto:concepto,motivo:motivo,ruta:ruta,
                   observacion:observacion,emisor:emisor,asunto:asunto,prioridad:criticidad,barrio:barrio,tipo_doc_apor:tipo_doc_apor,
                   doc_aportante:doc_aportante}
          });
         return (request.then(handleSuccessPost,handleError));
      },
