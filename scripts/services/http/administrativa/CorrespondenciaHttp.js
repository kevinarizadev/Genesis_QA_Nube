...
/**
* @ngdoc service
* @name GenesisApp.service:CorrespondenciaHttp
* @description
* # servicio http para el llamado al web services de todos los procedimientos del pqr.*/
angular.module('GenesisApp')
  .service('CorrespondenciaHttp', function ($http, $q) {
    return ({
    ...
    //   },
      ...
      get_regionales_corresp: function (res) {
        var request = $http({
          method: 'POST',
          url: "php/administrativa/correspondencia.php",
          data: { function: 'P_OBTENER_REGIONALES_CORRESP', ubicacion: res }
        });
        return (request.then(handleSuccessPost, handleError));
      },
      get_areas_corresp: function (res) {
        var request = $http({
          method: 'POST',
          url: "php/administrativa/correspondencia.php",
          data: { function: 'P_OBTENER_AREAS_RESP_CORRESP', ubicacion: res }
        });
        return (request.then(handleSuccessPost, handleError));
      },
      get_correspon_ubicacion: function (area, ubicacion) {
        var request = $http({
          method: "POST",
          url: "php/administrativa/correspondencia.php",
          data: { function: 'P_OBTENER_AREAS_UBI_RESP_CORRESP', ubicacion, area }
        });
        return (request.then(handleSuccess, handleError));
      },
...
// -- --------------------------------yordis 16/06/2023------------------------------------------------------ --
    ...
    // pqr ips
     ...
     get_macromotivos_especifico_tiporad: function (rad, tipodesolicitud) {
        var request = $http({
          method: "POST",
          url: "php/administrativa/correspondencia.php",
          data: { function: 'p_obtener_macromotivos_especifico_tiporad', tiporad: rad, tipodesolicitud }
        });
        return (request.then(handleSuccess, handleError));
      }
