...
angular.module("GenesisApp").controller("procesosespecialesFController", [
  ...
  function ($scope, $http) {
    ...
    $scope.cargaPeriodos = function (info) {
      //if ($scope.anno != "X" || $scope.anno === undefined) {
        $http({
          method: "POST",
          url: "php/financiera/funcfinanciera.php",
          data: { function: "cargaperiodos", anno: info },
        }).then(function (res) {
     ...
     // console.log($scope.tipodeItem);
      if ($scope.tipodeItem == "0") {
        ...
        switch ($scope.tipodeItem) {
          ...
          $scope.Nombrereporte = "Facturas Procesadas";
          ...
          case "86": // Archivo Tipo FT0011
            ...
            $scope.show_municipio = false;
            break;
          case "87": // Historico de contratacion
            $scope.show_ano = false;
            $scope.show_regimen = false;
            $scope.show_ciclo = false;
            $scope.show_mensual = false;
            ...
            $scope.show_nit = false;
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Historico de contratacion";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
            ...
            $scope.show_municipio = false;
            break;
          case "89": // Devolucion de Facturas
            $scope.show_ano = false;
            $scope.show_regimen = false;
            $scope.show_ciclo = false;
            $scope.show_mensual = false;
            ...
            $scope.show_nit = false;
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Devolucion de Facturas";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
            ...
            $scope.show_municipio = false;
            break;
          case "96": // Devolucion de Facturas
          $scope.show_ano = true;
          $scope.show_regimen = false;
          $scope.show_ciclo = false;
          $scope.show_mensual = true;
          ...
          $scope.show_nit = false;
          $scope.cicloTrimestre = false;
          $scope.Nombrereporte = "Generacion Reservas Tecnicas";
          $scope.contenido1 = true;
          $scope.show_ubicacion = false;
          $scope.show_concepto = false;
          $scope.show_fecha_recibico = false;
          ...
          case "103": // Edad Cartera Vigente
            ...
            $scope.show_nit = true;
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Edad Cartera Vigente";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
        ...
        switch ($scope.tipodeItem) {
          ...
          case "27": //Facturas Procesadas
            if ($scope.anno == "" || $scope.anno == undefined ) {
               swal({
                 title: "Mensaje",
                 text: "Por favor seleccione el año para generar el reporte",
                 type: "warning",
               });
                     return
             } else {
               ...
               swal({
                 title: "¿Desea Generar Proceso de facturas procesadas?",
                 text: "Generar Proceso",
                 type: "info",
                 showCancelButton: true,
                 confirmButtonText: "Confirmar",
                 ...
                 .then(function (result) {
                   if (result) {
                     ...
                     $http({
                       ...
                       url: "php/financiera/reportes/funcreportes.php",
                       data: {
                         function: "Cargue_facturasProcesadas",
                         datos: datosRC,
                       },
                     }).then(function (response) {
                       console.log(response);
          ...
          case "80": //Reporte de Informes para Comite de Pagos
            if ($scope.anno == "") {
              ...
              if (
                ...
                swal({
                  title:
                    "¿Desea Generar Reporte de Informes para Comite de Pagos?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
          ...
          case "87": // Historico de contratacion
            ...
            swal({
              title: "¿Desea Generar el Historico de contratacion?",
              text: "Generar Proceso",
              type: "info",
              showCancelButton: true,
              confirmButtonText: "Confirmar",
              ...
              .then(function (result) {
                if (result) {
                  ...
                  $http({
                    ...
                    url: "php/financiera/reportes/funcreportes.php",
                    data: {
                      function: "Historico_Contratacion",
                      datos: datosRC,
                    },
                  }).then(function (response) {
                    //console.log(response);
          ...
          case "89": // Devolucion de Facturas
            ...
            swal({
              ...
              .then((willDelete) => {
                if (willDelete) {
                  var fecha_inicio = $scope.formatDate($scope.fecha_inicio);
                  var fecha_final = $scope.formatDate($scope.fecha_final);
                  window.open('php/financiera/reportes/reporte_devolucion_facturas.php?fecha_inicio='+fecha_inicio+'&fecha_final='+fecha_final);
                  swal({
                    title: "Mensaje",
                    text: "Generando reporte de devolucion de facturas",
                    type: "success",
                  });
                  $scope.incio_vacio();
                }
          ...
          if ($scope.anno == "") {
            ...
            if (
              ...
              swal({
                title: "¿Desea Generar Reporte Gen_Reservas_Tecnicas?",
                text: "Generar Proceso",
                type: "info",
                showCancelButton: true,
                confirmButtonText: "Confirmar",
                ...
                .then(function (result) {
                  if (result) {
                    ...
                    $http({
                      ...
                      url: "php/financiera/reportes/funcreportes.php",
                      data: {
                        function: "Gen_Reservas_Tecnicas",
                        datos: datosRC,
                      },
                    }).then(function (response) {
                      //console.log(response);
          ...
          case "103": // Edad Cartera Vigente
            if ($scope.anno == "") {
              ...
              if (
                ...
                swal({
                  title: "¿Desea Generar Reporte De Edad Cartera Vigente?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
