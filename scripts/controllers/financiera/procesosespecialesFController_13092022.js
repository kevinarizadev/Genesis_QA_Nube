...
angular.module('GenesisApp')
   .controller('procesosespecialesFController', ['$scope', '$http',
      function ($scope, $http) {
            ...
            if ($scope.tipodeItem == "0") {
               ...
               switch ($scope.tipodeItem) {
                  ...
                  case "72":
                     ...
                     break;
                  case "73":
                     // Analisis de Autorizaciones Venc 12 meses
                     console.log($scope.periodo);
                     var datosRC = {
                        "correo": $scope.correo,
                        "anno": $scope.anno,
                     ...
                     swal({
                        title: '¿Desea Generar Proceso Analisis de Autorizaciones Venc 12 meses?',
                        text: "Generar Proceso",
                        type: 'info',
                        showCancelButton: true,
                        confirmButtonText: "Confirmar",
