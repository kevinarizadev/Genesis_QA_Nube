...
angular.module('GenesisApp').controller('afiliacion_linea_controller', ['$scope', '$http', 'consultaHTTP', 'notification', 'ngDialog', '$filter', function ($scope, $http, consultaHTTP, notification, ngDialog, $filter) {
  ...
  $scope.validarbeneficiario_eps = function(event,afiliacion){
    if(event.keyCode == 9) {
      $scope.formatcurrency(4, afiliacion.eps_anterior, afiliacion.options_eps_anterior);
      $scope.buscar_beneficiario();
    }
  }
  $scope.buscar_beneficiario = function () {
    ...
    //
    // afiliacion.eps_anterior
    if( $scope.afiliacion.eps_anterior.slice(0, 6) != '000000'){
      return;
    }
    //
  ...
  $scope.validarLongitudTipoDoc_Ben_CN = function () {
    ...
    if ($scope.afiliacion.numero_documento_beneficiario_CN.toString().length < 9 || $scope.afiliacion.numero_documento_beneficiario_CN.toString().length > 14) {
      $scope.afiliacion.numero_documento_beneficiario_CN = '';
