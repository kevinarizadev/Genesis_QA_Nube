"use strict";angular
  ...
  .controller("matrizdeseguimientoController", ["$scope","$http","$window",function ($scope, $http, $window) {
      ...
      $scope.function_agregarActividad = function () {
        if (!$scope.form1.fechaSolicitud || !$scope.form1.nombreModulo || !$scope.form1.area || !$scope.form1.descripcion || !$scope.form1.fechaInicio ||
           !$scope.form1.personaSoliciatnte) {
            ...
            swal("Importante", "Por favor seleccione almenos un recurso(*)", "info");
      ...
      $scope.function_consultaReporte = function (info){
        if(info == 'A'){
          $scope.busquedaInfo = "";
          $scope.title = 'SEGUIMIENTOS ACTIVOS';
          // if ( $scope.form2.fechaInicio == "" || $scope.form2.fechaInicio == undefined ||   $scope.form2.fechaFinal == "" || $scope.form2.fechaFinal == undefined) {
          //   swal("Importante", "Complete los campos requeridos (*)", "info");
          //   let elementosAValidar = [
          //     {
          //       Codigo: "1",
          //       id_label: "id_form2_fechaInicio_label",
          //       id_input: "id_form2_fechaInicio",
          //     },
          //     {
          //       Codigo: "2",
          //       id_label: "id_form2_fechaFinal_label",
          //       id_input: "id_form2_fechaFinal",
          //     }
          //   ];
          //   elementosAValidar.forEach(function (elemento) {
          //     $scope.validarVacio(elemento.id_input, elemento.id_label);
          ...
          // } else {
            ...
            //   data: {
            //     function: 'P_REPORTE_PROYECTO',
            //     vpfechainicial:$scope.formatDatefecha($scope.form2.fechaInicio),
            //     vpfechafinal:$scope.formatDatefecha($scope.form2.fechaFinal),
            //     }
            // }).then(function ({data}) {
            //   console.log(data);
            //     swal.close();
            ...
            //             XLSX.utils.book_append_sheet(workbook, ipsSheet, "Reporte de actividades");
            //             // XLSX.utils.book_append_sheet(workbook, epsSheet, "EPS");
            //             // Generar un archivo Excel
            //             XLSX.writeFile(workbook, "Reporte de actividades.xlsx");            
          ...
          swal({
            title: "¡Alerta!",
            text: 'Estamos trabajando en el reporte solicitado, Gracias',
            type: "warning"
          }).catch(swal.noop);
      ...
      $scope.formatnumeroytexto_Mayuscula = function (NID) {
