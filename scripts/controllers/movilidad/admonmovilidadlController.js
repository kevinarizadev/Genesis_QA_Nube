        ...
        function ($scope, consultaHTTP, notification, $timeout, $rootScope, $http, $window, ngDialog) {
            ...
            $scope.Inicio = function () {
                ...
                const asistentesRegionales = [
                    ...
                    { cedula: '1083032232' }, // MAGDALENA - PINEDO SUAREZ LUISA FERNANDA - 1083032232
                    { cedula: '22739253' } // MAGDALENA - HERRERA LOPEZ OLEIDIS ESTHER - 22739253
                ];
                ...
                const asistentesNacionales = [
                    ...
                    { cedula: '1001819767' }, // 1001819767 - ARZUZA FONTALVO SHELY DENIT
                    { cedula: '72189418' }, // 72189418 - ARZUZA FONTALVO SHELY DENIT
                    { cedula: '1042454684' }, // K A - 1042454684
                    { cedula: '72298162' }, // JUAN MOISES SABALZA - 72298162
                ];
            ...
            $scope.editarinfor = function () {
                ...
                if ($scope.editar_informacion == false) {
                    ...
                    $('#nomcargo').removeAttr('disabled', 'disabled');
                    $('#celcargo').removeAttr('disabled', 'disabled');
                    $('#telcargo').removeAttr('disabled', 'disabled');
                    $('#fechadelcargo').removeAttr('disabled', 'disabled');
                    $('#correotipoempresas').removeAttr('disabled', 'disabled');
            ...
            $scope.llenarform = function (objeto) {
                console.log(objeto);
                //Estado
                $scope.estadoempresaanulada = objeto.codigo_estado_registro;
                $scope.nitdelaempresa = objeto.documento;
            ...
            $scope.Activar_Empresa_Anulada = function () {
                swal({
                    title: 'Confirmar',
                    text: '¿Desea Activar esta Empresa?',
                    type: 'question',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    $http({
                        ...
                        data: {
                            ...
                            nitempresa: $scope.nitdelaempresa,
                        }
                    }).then(function (response) {
                        if (response.data.codigo == 0) {
                            swal('Completado', response.data.mensaje, 'success');
            ...
            $scope.descargar_empresa_asesores_activos = function (estado) {
                ...
                swal.showLoading();
                let xEstado = estado == 'Activas' ? 'A' : estado == 'Inactivas' ? 'X' : 'P';
                $http({
                    method: 'GET',
