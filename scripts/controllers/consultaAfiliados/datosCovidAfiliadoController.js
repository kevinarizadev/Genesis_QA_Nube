...
angular.module('GenesisApp')
  .controller('DatosCovidAfiliadoController', ['$http', '$timeout', '$scope', 'ngDialog', 'consultaHTTP', 'afiliacionHttp',
    function ($http, $timeout, $scope, ngDialog, consultaHTTP, afiliacionHttp) {
      ...
      $scope.ConsultarAfiliado = function () {
        ...
        $http({
          ...
          data: { function: 'BuscaAfiliadoSinDocumento' }
      ...
      // $scope.ConsultarAfiliadoAfiliado()
      ...
      $scope.muestraResultado = function () {
        $scope.ValidaInformacion = true
      }
