...
angular.module('GenesisApp')
  ...
  .controller('modalconsultaautorizacionesController', ['$scope', '$http', '$location', '$filter', 'ngDialog', '$timeout', 'pqrHttp', 'afiliacionHttp', function ($scope, $http, $location, $filter, ngDialog, $timeout, pqrHttp, afiliacionHttp) {
    ...
    setTimeout(() => {
        console.log($scope.autorizacion_selecionada)
        $scope.openmodals('modaldetalle', $scope.autorizacion_selecionada);      
    }, 100);
