    ...
    function ($scope, $http, $filter) {
      ...
      $scope.direccionamientoIps = function (estado) {
        if (estado == 'M' && $scope.codigodeValidacion == 2) {
          ...
          if ($scope.procesodireccionamientoHospitalario == '' || $scope.procesodireccionamientoHospitalario == null || $scope.procesodireccionamientoHospitalario == undefined) {
            return
          } else {
            $http({
              method: 'POST',
              ...
              data: {
                function: 'obtenerNombreipsReceptora',
                ips: $scope.procesodireccionamientoHospitalario || 'X',
                vpnumeroips: $scope.direccionamiento.pnumero,
                vptipo: $scope.tipoProceso,
                vpaccion: $scope.respuestmodalValidacion
              }
