  ...
  .controller('registrodereferenciacontroller', ['$scope', '$http', '$filter',
    function ($scope, $http, $filter) {
      ...
      $scope.Inicio = function () {
        ...
        // $scope.horas = $scope.formatDate($scope.form3.horaAceptacion);
        $(".modal").modal();
        //TABLA
      ...
      $scope.buscarAfiliado = function () {
        if ($scope.form2.selecctipoDocumento == "" || $scope.form2.seleccnumeroDocumento == "" || $scope.form2.tipoSolicitud == "") {
          swal({
            title: "¡Alerta!",
      ...
      $scope.buscarDiagnostico = function (diag, numero) {
        ...
        if (numero == 1) {
          if ($scope.form2.edadPaciente == "" || $scope.form2.edadPaciente == undefined || $scope.form2.generoPaciente == "" || $scope.form2.generoPaciente == undefined) {
            swal('Importante', 'Debe diligenciar la informacion del paciente!', 'info');
          } else {
            var sexo = $scope.form2.generoPaciente;
            var edad = $scope.form2.edadPaciente;
          }
        } if (numero == 2) {
          if ($scope.form4.edadPaciente == "" || $scope.form4.edadPaciente == undefined || $scope.form4.generoPaciente == "" || $scope.form4.generoPaciente == undefined) {
            swal('Importante', 'Debe diligenciar la informacion del paciente!', 'info');
          } else {
            var sexo = $scope.form4.generoPaciente;
            var edad = $scope.form4.edadPaciente;
          }
        }
        $http({
          method: 'POST',
      ...
      $scope.Set_Tab = function (x, grupo) {
        ...
        if (x == 6) {
          ...
          console.log($scope.validacionDocumento);
          $scope.validacionStatus = grupo.NOMBRE_STATUS;
          console.log($scope.validacionStatus);
      ...
      /////////////////////////////////////////PAGINACION/////////////////////////////////////////////////
      $scope.filtro_tabs = function (fil) {
        console.log(fil);
