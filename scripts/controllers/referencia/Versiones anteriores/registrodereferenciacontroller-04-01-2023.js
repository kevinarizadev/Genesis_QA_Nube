...
angular.module('GenesisApp')
  .controller('registrodereferenciacontroller', ['$scope', '$http', '$timeout', '$filter',
    function ($scope, $http, $timeout, $filter) {
      ...
      $scope.listarmotivodeRechazo = function (motivo) {
        // console.log(motivo);
        $http({
          method: 'POST',
        url: "php/referencia/registroReferencia/registrodereferencia.php",
      ...
      $scope.listarmotivodeCancelacion = function (motivo) {
        console.log(motivo);
        $http({
          method: 'POST',
        url: "php/referencia/registroReferencia/registrodereferencia.php",
      ...
      $scope.guardarReferencias = function () {
        if ($scope.form2.nombreSolicitante == '' || $scope.form2.nombreSolicitante == null || $scope.form2.nombreSolicitante == undefined) {
          swal({
            title: "Notificación",
            text: 'No se permiten campos vacios en el formulario',
            type: "warning"
        ...
        if ($scope.form3.nombreipsRecep == '' || $scope.form3.nombreipsRecep == null || $scope.form3.nombreipsRecep == undefined) {
          ...
          url: "php/referencia/registroReferencia/registrodereferencia.php",
            data: {
              ...
              profesional_gestion: $scope.form3.profesinal,
        ...
        if ($scope.modal3.nombreipsRecep == '' || $scope.modal3.nombreipsRecep == null || $scope.modal3.nombreipsRecep == undefined) {
          ...
          url: "php/referencia/registroReferencia/registrodereferencia.php",
            data: {
              ...
              profesional_gestion: $scope.modal3.profesinal,
        ...
        if ($scope.modal5.nombreipsRecep == '' || $scope.modal5.nombreipsRecep == null || $scope.modal5.nombreipsRecep == undefined) {
          ...
          url: "php/referencia/registroReferencia/registrodereferencia.php",
            data: {
              ...
              profesional_gestion: $scope.modal5.profesinal,
        ...
        if ($scope.modal4.nombreipsRecep == '' || $scope.modal4.nombreipsRecep == null || $scope.modal4.nombreipsRecep == undefined) {
          ...
          url: "php/referencia/registroReferencia/registrodereferencia.php",
            data: {
              ...
              profesional_gestion: $scope.modal4.profesinal,
        ...
        if ($scope.modal1.observaciones == '') {
          ...
          url: "php/referencia/registroReferencia/registrodereferencia.php",
            data: {
              ...
              pdocumento: $scope.modal1.numeroDcocumento,
              ptipo_gestion: obser,
      ...
      $scope.listrefrenciasActivas = function () {
        ...
        url: "php/referencia/registroReferencia/registrodereferencia.php",
          ...
          if (response.data && response.data.toString().substr(0, 3) != '<br') {
            ...
            // console.log($scope.Vista1_datos);
      ...
      $scope.openmodals = function (tipo, opcion) {
        ...
        switch (tipo) {
          ...
          case 'observaciones':
            ...
            $scope.modal1.numeroDcocumento = opcion.COD_DOCUMENTO;
      ...
      $scope.handleKeyPress = function (e) {
        if ($scope.modal1.observaciones == null || $scope.modal1.observaciones == undefined || $scope.modal1.observaciones == '') { $scope.count = 0; }
        if ($scope.modal1.observaciones.length < $scope.count) { $scope.count = $scope.modal1.observaciones.length }
        else ($scope.modal1.observaciones.length > $scope.count)
        { $scope.count = $scope.modal1.observaciones.length }
        if (e.keyCode == 8) {
          if ($scope.count == 0) {
            $scope.count = 0;
          }
