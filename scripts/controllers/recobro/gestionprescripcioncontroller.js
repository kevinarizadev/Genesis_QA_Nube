...
angular
  ...
  .controller("gestionprescripcioncontroller", [
    ...
    function (
          ...
          mipresHTTP
            ...
            .then(function (res) {
              ...
              if (res.length == 0) {
                ...
                $scope.rutadocumentocargado($scope.resultado2[0].prescripcion.NoPrescripcion);
      ...
      $scope.AbrirModal_subirabjunto = function (numero_pres) {
        //
        $("#Modal_subir_abjunto").modal("open");
        $scope.NumeroPrescripcion = numero_pres; //
        $scope.Modal_subir_abjunto = "";
        $scope.inactivebarradiag = true;
      };
      ...
      $scope.validararchivo = function (){
        ...
        $scope.getBase64($scope.inputFile.files[0]).then(function (result) {
          $scope.abjuntoprescripcion = result;
        });
      
      }

      $scope.InsertarAbjuntoPrescripcion = function () {
        $http({
          method: "POST",
          url: "php/recobro/mipres.php",
          data: {
            ...
            v_archivo: $scope.abjuntoprescripcion
          },
        }).then(function (response) {
          if (
            response.data &&
      ...
      $scope.rutadocumentocargado = function (numeroprescripcion) {
        $http({
          method: "POST",
          url: "php/recobro/mipres.php",
          data: {
            function: "obteneruta",
            v_num_prescripcion: numeroprescripcion,
          },
        }).then(function (response) {
          if (
            response.data &&
            ...
            $scope.Rutadocumentocargado = response.data[0].ruta;
          $scope.bloquearboton = $scope.Rutadocumentocargado == '' ? true : false;
          } else {
            swal({
              title: "¡Ocurrio un error!",
              text: response.data,
    ...
    $scope.AbrirModal_verabjunto = function () {
      $http({
        method: 'POST',
        url: "php/recobro/mipres.php",
        data: {
            function: 'descargaAdjunto',
            ruta: $scope.Rutadocumentocargado
        }
      }).then(function (response) {
