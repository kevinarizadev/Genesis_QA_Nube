...
.controller('procnovalidoscontroller',['$scope','consultaHTTP','notification','cfpLoadingBar','$http',function($scope,consultaHTTP,notification,cfpLoadingBar,$http) {
   ...
   $scope.muestraFacturas = function(){
      $http({
         method:'GET',
         url:"php/salud/obtenerfacturas_procer.php"
   ...
   $scope.muestraDetalleFacturas = function(nit,factura,recibo,tipo,id,afiliado,edad,sexo){
      ...
      $http({
         method:'GET',
         url:"php/salud/obtenerdetallefacturas_procer.php",
         params: {nit: nit,
                  factura: factura,
                  recibo:recibo,
                  tipo : tipo,
