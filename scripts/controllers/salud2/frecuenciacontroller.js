...
.controller('frecuenciacontroller',['$scope','consultaHTTP','notification','cfpLoadingBar','$http',function($scope,consultaHTTP,notification,cfpLoadingBar,$http) {
   $scope.tabladetalle = true;
   $scope.muestraFacturas = function(){
      $http({
         method:'GET',
         url:"php/salud/obtenerfacturas_frecuencia.php"
      ...
      $http({
         method:'GET',
         url:"php/salud/cantidad_frecuencia.php"
