...
angular.module('GenesisApp')
    .controller('historicodesnutricionController', ['$scope', '$http', 'ngDialog', 'notification', 'ausentismoHttp', '$timeout', '$q', 'communication', '$controller', '$rootScope', '$window', '$filter',
        function ($scope, $http, ngDialog, notification, ausentismoHttp, $timeout, $q, communication, $controller, $rootScope, $window, $filter) {
            ...
            // #region "Esquema de vacunación"
            $scope.cargarEsquemaVacunacion = function (codigo_semana, codigo_desnutricion) {
                $http({
                    method: 'POST',
                    url: "php/saludpublica/desnutricion/funcDesnutricion.php",
                    data: { function: 'obtenerEsquemaVacunacion', codigo_desnutricion: `${codigo_desnutricion}`, codigosemana: `${codigo_semana}` }
                }).then(function (res) {
