  ...
  .controller("seguimientoCACController", [
    ...
    function (
     ...
     $scope.Tabs = 1;
      ...
      $scope.resumenRegionales = function (info) {
        // $scope.textCohorte = info.DESCRIPCIONCOHORTE;
        $http({
          method: "POST",
          url: "php/altocosto/seguimientoCAC.php",
          data: {
            function: "resumen_Regionales",
            // vcohorte: info.DESCRIPCIONCOHORTE
          },
        }).then(function (response) {
          swal.close();
          if (response.data && response.data.toString().substr(0, 3) != "<br") {
            $scope.list_resumen_regional = response.data;
      ...
      $scope.resumencohorteGeneral = function (info) {
        ...
        $http({
          ...
          if (response.data && response.data.toString().substr(0, 3) != "<br") {
            ...
            //   if (x.DESCRIPCIONCOHORTE == 'ARTRITIS') {
            //     $scope.filtroCohorte = 'ARTRITIS';
            //     $scope.rutaimagenCohorte = 'assets/images/Cohorte/bone-broken-broken.svg';
            //   } if (x.DESCRIPCIONCOHORTE == 'CANCER') {
            //     $scope.filtroCohorte = 'CANCER';
            //     $scope.rutaimagenCohorte = 'assets/images/Cohorte/cancer.svg';
            //     console.log($scope.rutaimagenCohorte);
            //   }
            // });
