...
$scope.PrintCarta = function (cd,estado) {
      console.log(cd);
       if (cd.tipo_cotizante == '3' || '4'||'16'||'34'||'35'||'36'||'42'||'43'||'52'||'53'||'56'||'57'||'58'||'59') {     
            $window.open('views/cartera/print/printhistoricoind.html?estado='+estado+'&tipo='+cd.tipo_doc_aportante+'&id='+cd.doc_aportante,'_blank', "width=1080,height=1100");
      } else {
