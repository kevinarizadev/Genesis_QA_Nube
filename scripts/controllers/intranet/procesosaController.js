...
angular.module('GenesisApp')
    .controller('procesosaController', ['$scope', '$http', 'ngDialog', '$timeout', '$q', 'upload', '$controller', '$rootScope', '$window',
        function ($scope, $http, ngDialog, $timeout, $q, $controller, $rootScope, $window) {
            ...
            //     {
            //         id: 0,
            //         icono: "images/iconos/mapa_procesos/MACROPROCESOS ESTRATEGICOS.png",
            //         opciones: [
            //             {
            //                 id: 0,
            //                 icono: "images/iconos/mapa_procesos/DIRECCION.png"
            //             },
            //             {
            //                 id: 1,
            //                 icono: "images/iconos/mapa_procesos/GESTION DE LAS TIC.png"
            //             },
            //             {
            //                 id: 2,
            //                 icono: "images/iconos/mapa_procesos/SEGUIMIENTO CONTROL Y EVALUACION DE CONTROL INTERNA.png"
            //             }
            //         ]
            //     },
            //     {
            //         id: 1,
            //         icono: "images/iconos/mapa_procesos/MACROPROCESOS MISIONALES.png",
            //         opciones: [
            //             {
            //                 id: 0,
            //                 icono: "images/iconos/mapa_procesos/GESTION C RED DE SERVICIOS.png"
            //             },
            //             {
            //                 id: 1,
            //                 icono: "images/iconos/mapa_procesos/GESTION DE AFILIACION INSCRIPCION Y MERCADEO.png"
            //             },
            //             {
            //                 id: 2,
            //                 icono: "images/iconos/mapa_procesos/GARANTIA PLAN DE BENEFICIOS DE SALUD.png"
            //             },
            //             {
            //                 id: 3,
            //                 icono: "images/iconos/mapa_procesos/PROTECCION AL USUARIO Y PARTICIPACION CIUDADANA.png"
            //             }
            //         ]
            //     },
            //     {
            //         id: 2,
            //         icono: "images/iconos/mapa_procesos/MACROPROCESOS DE APOYO.png",
            //         opciones: [
            //             {
            //                 id: 0,
            //                 icono: "images/iconos/mapa_procesos/GESTION HUUMANAA.png"
            //             },
            //             {
            //                 id: 1,
            //                 icono: "images/iconos/mapa_procesos/GEESTION FINANCIERA.png"
            //             },
            //             {
            //                 id: 2,
            //                 icono: "images/iconos/mapa_procesos/GESTION DE LA INFRAESTRUCTURA.png"
            //             },
            //             {
            //                 id: 3,
            //                 icono: "images/iconos/mapa_procesos/ADQUISICION DE BIENES Y SERVICIOS.png"
            //             },
            //             {
            //                 id: 4,
            //                 icono: "images/iconos/mapa_procesos/GESTION CUENTAS MEDICAS.png"
            //             },
            //             {
            //                 id: 5,
            //                 icono: "images/iconos/mapa_procesos/GESTION DOCUMENTAL.png"
            //             },
            //             {
            //                 id: 6,
            //                 icono: "images/iconos/mapa_procesos/GESTION JURIDICA.png"
            //             }
            //         ]
            //     }
            // ];
            ...
            $scope.addProcesses = function (index, add = false, name = '', type = '', stade = '', titulo = '') {
                ...
                if (add) {
                    if ($scope.panel.file != "" && name != "" && stade != "") {
            ...
            $scope.BtnGuardar = function () {
                if ($scope.panel.archivos.length == 0) {
                    $scope.update = { procesos: $scope.macroprocesos };
                    $http({
                        method: 'POST',
                        url: "php/intranet/intranet_procesos.php",
                        data: {
                            function: 'updateJson',
                            json: JSON.stringify($scope.update)
                        }
                    }).then(function (response) {
                ...
                link: function postLink($scope, elem, attrs, ngModel) {
                    ...
                    elem.on("change", function (e) {
                        ...
                        if ($(this)["0"].files.length > 0) {
                            if (files && this.files[0].type == "application/pdf" || this.files[0].type == "application/msword" || this.files[0].type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document" || this.files[0].type == "application/vnd.ms-excel" || this.files[0].type == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
                                ...
                                swal('Advertencia', 'El archivo no es un formato valido (PDF, Excel, Word)', 'warning');
                                clear = true;
                            }
                        } else {
                            clear = true;
