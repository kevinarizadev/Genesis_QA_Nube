  ...
  .controller('generaciondeCapitaController', ['$scope', '$http', 'notification', 'acasHttp', 'ngDialog', '$filter', 'communication', '$rootScope',
    function ($scope, $http, notification, acasHttp, ngDialog, $filter, communication, $rootScope) {
      $scope.Inicio = function () {
        ...
        $scope.function_p_valida_periodo();
        $scope.limpiarTabs1();
        $scope.limpiarTabs2();
      ...
      $scope.function_p_valida_periodo = function () {
        $http({
          method: 'POST',
          url: "php/contratacion/generaciondecapita.php",
          data: { function: 'P_VALIDA_PERIODO' }
        }).then(function (response) {
          //console.log(response);
          $scope.function_p_control_boton(response);
          ...
          $scope.function_p_estado_capita();
          if ($scope.periodo == "G") {
      ...
      $scope.function_p_control_boton = function (info) {
        console.log('line 91 - function_p_control_boton',info);
        $http({
          method: 'POST',
          url: "php/contratacion/generaciondecapita.php",
          data: {
          ...
          console.log('line 100 - function_p_control_boton',response);
      ...
      // Funcion para crear el capita
      $scope.function_p_ejecutar_capita = function () {
        swal({
          title: 'Confirmar Proceso',
          text: "Está seguro que desea generar la capita?",
          type: 'question',
          ...
          if (result) {
            ...
            $http({
              ...
              data: {
                ...
                vpperiodo: $scope.periodo,
                vpresponsable: $scope.responsable
              }
            })
              .then(function (response) {
                console.log(' linea 339 function_p_ejecutar_capita',response);
                swal.close();
      ...
      $scope.function_p_estado_capita = function () {
        $http({
          method: 'POST',
          url: "php/contratacion/generaciondecapita.php",
          data: {
          ...
          console.log('Linea 472 - function_p_estado_capita',response);
