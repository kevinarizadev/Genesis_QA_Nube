...
angular.module('GenesisApp')
  .controller('supervisiondecontratoController', ['$scope', '$http', '$window',
    function ($scope, $http, $window) {
      ...
      $scope.procesodepreguntasPausadas = function (data, accion) {
        // console.log(data);
        // console.log(accion);
        let info = accion + 1;
        if (data.PROCESO == 8) {
          ...
          $scope.preguntaProcesopausado = false;
          $scope.reglonpreguntasPausadas = data.ID_PROCESO;
          return
        } else if (info == 8) {
          $scope.calcularResultado = true;
          $scope.preguntaProcesopausado = false;
        ...
        if (accion == 'U') {
          ...
          $http({
            ...
            data: {
              ...
              vpidproceso: $scope.dataReglon || $scope.info_v_pidproceso ||  $scope.reglonpreguntasPausadas
            }
          }).then(function (response) {
      ...
      $scope.optener_Resultado = function (accion) {
        if (accion == 'U') {
          ...
          $http({
            ...
            data: {
              function: 'optenerResultado',
              vpidproceso: $scope.infoRenglon || $scope.info_v_pidproceso || $scope.reglonpreguntasPausadas
            }
          }).then(function (response) {
        ...
        if (accion == 'U') {
          ...
          if ($scope.form1.observacionesResult2 == '' && $scope.form1.observacionesResult2 == '') {
            ...
            $http({
              ...
              data: {
                function: 'guardarResultado',
                vpidproceso: $scope.infoRenglon || $scope.reglonpreguntasPausadas,
              ...
              if (response.data && response.data.toString().substr(0, 3) != '<br') {
                ...
                if($scope.infoRenglon == undefined){
                  $window.open('views/contratacion/formatos/supervisiondeloscontratos.php?&vprenglon=' + $scope.reglonpreguntasPausadas );
                  return
                }
