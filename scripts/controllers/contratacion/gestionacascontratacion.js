'use strict';
angular.module('GenesisApp').controller('gestionacascontratacion', ['$scope', '$http', 'ngDialog', function ($scope, $http, ngDialog) {

  $(document).ready(function () {
    $scope.obtener_gestionacascontratacion();
  });
  ...
  $scope.obtener_gestionacascontratacion = function (nombre_concepto) {
  ...
  $scope.getAcasConcepto_responsables = function (concepto, tipo, activos, procesados, nombre) {
    $scope.concepto_persona = concepto;
    ...
    $http({
      method: 'POST',
      url: "php/contratacion/gestionacascontratacion.php",
      data: { function: 'obteneracasconcepto_responsable', concepto: concepto, tipo: tipo }
    }).then(function (response) {
      if (response.data != undefined) {
  ...
  $scope.getAcasConcepto = function (cedula, estado, cantidad, nombre) {
    ...
    $http({
      method: 'POST',
      url: "php/contratacion/gestionacascontratacion.php",
      data: { function: 'obteneracasconcepto', concepto: $scope.concepto_persona, estado: estado, tipo: $scope.tipo_persona, cedula: cedula }
    }).then(function (response) {
      console.log(response.data);
      if (response.data != undefined) {
