    ...
    .controller('CertificadoController', ['$scope', '$http', '$location', '$timeout',
        function ($scope, $http, $location, $timeout) {
            $.getJSON( "../../../php/obtenersession.php").done(function(respuesta) {
                ...
                $scope.nitempresa = respuesta.nit;
                $scope.nitnombreempresa = respuesta.nombre;
            ...
            $http({
                ...
                data: { function: 'ConsultarCertificado', empresa:$scope.nitempresa,tipo: $location.search().tipo, documento: $location.search().documento, inicial: $location.search().inicial, final: $location.search().final }
            }).then(function (res) {
