'use strict';
angular.module('GenesisApp').controller('gestionacascuentasm', ['$scope', '$http', 'ngDialog', function ($scope, $http, ngDialog) {
  ...
  $scope.obtener_gestionacasauditores = function (nombre_concepto) {
    ...
    $http({
      method: 'POST',
      url: "php/cuentasmedicas/gestionacascuentasm.php",
      data: {
  ...
  $scope.getAcasConcepto_responsables = function (concepto, tipo, activos, procesados, nombre) {
    ...
    $http({
      method: 'POST',
      url: "php/cuentasmedicas/gestionacascuentasm.php",
      data: { function: 'obteneracasmotivo_responsable', concepto: concepto, tipo: tipo }
    }).then(function (response) {
      if (response.data != undefined) {
        $scope.panel.activo = 2;
        $scope.Listado_Responsables = response.data;
        $scope.estado_empleado = response.data.estado_empleado;
