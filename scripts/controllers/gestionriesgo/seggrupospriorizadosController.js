    ...
    function ($scope, $http, $filter, $q, afiliacionHttp, ngDialog) {
      $(document).ready(function () {
        ...
        if ($(window).height() < 600) {
          angular.forEach(
            document.querySelectorAll(".Clase_AjustarHeigth_Modal_Soporte"),
            function (i) {
              i.style.height = "95vh";
            }
          );
        ...
        $scope.Color_Bg = "";
        $scope.pantalla = 1;
        $scope.Vista = "form_seg";
        $scope.SysDay = new Date();
        $scope.tab = 1;
        $scope.ListaTablaIncidentes = [];
        $scope.ListaTablaPrevalentes = [];
        $scope.ListaTablaIncidentesTemp = [];
        $scope.ListaTablaPrevalentesTemp = [];
        $scope.filtro = {
          tipo_Doc: undefined,
          documento: undefined,
          fechaIni: undefined,
          ...
          if (response.data && response.data.toString().substr(0, 3) != "<br") {
            if (response.data.Codigo == undefined) {
              ...
              setTimeout(() => {
                response.data.forEach((e) => {
                  ...
                  $scope.Lista_Tabla.push({
                    ...
                    NOM_COHORTE: e.NOM_COHORTE,
                  });
                });

                $scope.cardsInformativas.forEach((c) => {
                  c.ID == "R" ? (c.CANT = $scope.List_Count.Rips) : "";
                  c.ID == "A" ? (c.CANT = $scope.List_Count.Aut) : "";
                  c.ID == "M" ? (c.CANT = "") : "";
                  c.ID == "C" ? (c.CANT = $scope.List_Count.Censo) : "";
                  c.ID == "S" ? (c.CANT = "") : "";
                  c.ID == "V" ? (c.CANT = "") : "";
                  c.ID == "I" ? (c.CANT = "") : "";
                  c.ID == "P" ? (c.CANT = "") : "";
                  c.ID == "O" ? (c.CANT = $scope.List_Count.Otra) : "";
                });
              ...
              if (response.data.Codigo == 1) {
                ...
                document.querySelector("#pantalla").style.pointerEvents =
                  "none";
                swal({
                  title: "¡Ocurrio un error!",
                  text: response.data.Nombre,
      ...
      $scope.Cargar_Selects = function () {
        ...
        $http({
          ...
          if (response.data.toString().substr(0, 3) != "<br") {
            response.data.forEach((e) => {
              if (e.CONCEPTO == "NEC") {
                $scope.Array_Necesidad.push({
                  CODIGO: e.CODIGO,
                  TEXTO: e.NOMBRE,
                });
              }
              if (e.CONCEPTO == "SEG") {
                $scope.Array_Seguimiento.push({
                  CODIGO: e.CODIGO,
                  TEXTO: e.NOMBRE,
                });
              }
      ...
      $scope.Mostar_Formulario = function (X) {
        ...
        $scope.Color_Bg = "";
        if (X.FUENTE == "A") {
          $scope.Color_Bg = "BgColor_A";
          $scope.Color_Co = "Color_A";
        }
        if (X.FUENTE == "R") {
          $scope.Color_Bg = "BgColor_R";
          $scope.Color_Co = "Color_R";
        }
        if (X.FUENTE == "C") {
          $scope.Color_Bg = "BgColor_C";
          $scope.Color_Co = "Color_C";
        }
        if (X.FUENTE == "N") {
          $scope.Color_Bg = "BgColor_N";
          $scope.Color_Co = "Color_N";
        }
        if (
          X.FUENTE != "A" &&
          X.FUENTE != "R" &&
          ...
          $scope.Color_Bg = "BgColor_O";
          $scope.Color_Co = "Color_O";
        }
        ...
        if (X.STATUS == "1") {
          ...
          /***************************************** */
          angular.forEach(
            document.querySelectorAll(".Form_Campos_Desactivados input"),
            function (i) {
          ...
          angular.forEach(
            document.querySelectorAll(".Form_Campos_Desactivados select"),
            function (i) {
              i.setAttribute("disabled", true);
            }
          );
          angular.forEach(
            document.querySelectorAll(".Form_Campos_Desactivados textarea"),
            function (i) {
              i.setAttribute("disabled", true);
            }
          );
          setTimeout(() => {
            angular.forEach(
              document.querySelectorAll(".Form_Campos_Desactivados label"),
              function (i) {
          ...
          /***************************************** */
          angular.forEach(
            document.querySelectorAll(".Form_Campos input"),
            function (i) {
          ...
          angular.forEach(
            document.querySelectorAll(".Form_Campos select"),
            function (i) {
              i.removeAttribute("disabled");
            }
          );
          angular.forEach(
            document.querySelectorAll(".Form_Campos textarea"),
            function (i) {
              i.removeAttribute("disabled");
            }
          );
          ...
          setTimeout(() => {
            angular.forEach(
              document.querySelectorAll(".Form_Campos label"),
              function (i) {
          ...
          /***************************************** */
          angular.forEach(
            document.querySelectorAll(".Form_Campos_OtraFuente input"),
            function (i) {
              i.setAttribute("readonly", true);
              i.classList.add("class_gris");
            }
          ...
          angular.forEach(
            document.querySelectorAll(".Form_Campos_OtraFuente select"),
            function (i) {
              i.setAttribute("disabled", true);
            }
          );
          setTimeout(() => {
            ...
            angular.forEach(
              document.querySelectorAll(".Form_Campos_OtraFuente label"),
              function (i) {
                i.classList.add("class_label");
              }
            );
      ...
      $scope.Cargar_Formulario = function (X) {
        ...
        var Fecha_Gestion =
          X.FECHA_GESTION == "" ? $scope.SysDay : new Date(X.FECHA_GESTION);
        var Fecha_Nuevo_Seg =
          X.FECHA_NUEVO_SEG == "" ? $scope.SysDay : new Date(X.FECHA_NUEVO_SEG);
        // var Fecha_Registro = (X.FECHA_REGISTRO == '') ? $scope.SysDay : new Date(X.FECHA_REGISTRO);
        var Fecha_Inicio =
          X.FECHA_INICIO == "" ? $scope.SysDay : new Date(X.FECHA_INICIO);
        var Fecha_Fin =
          X.FECHA_FIN == "" ? $scope.SysDay : new Date(X.FECHA_FIN);
        // var Fecha_Term_Embarazo = (X.FECHA_TERM_EMBARAZO == '') ? $scope.SysDay : new Date(X.FECHA_TERM_EMBARAZO);
        var Fecha_Ultima_Men =
          X.FECHA_ULTIMA_MESTRUACION == ""
            ? $scope.SysDay
            : new Date(X.FECHA_ULTIMA_MESTRUACION);
        ...
        $scope.Form = {
          ...
          Diagnostico:
            X.COD_DIAGNOSTICO == ""
              ? ""
              : X.COD_DIAGNOSTICO + " - " + X.NOM_DIAGNOSTICO,
        ...
        setTimeout(() => {
          document
            .getElementById("Hoja_Form")
            .scrollIntoView({ block: "start", behavior: "smooth" });
          document
            .querySelector("#Afi_Telefono_1")
            .dispatchEvent(new KeyboardEvent("keyup"));
          document
            .querySelector("#Afi_Celular_1")
            .dispatchEvent(new KeyboardEvent("keyup"));
          document
            .querySelector("#Afi_Celular_2")
            .dispatchEvent(new KeyboardEvent("keyup"));
        ...
        document
          .querySelector(".input-file-radiu")
          .classList.remove("input-file-radius-cargado");
        document
          .querySelector(".input-file-radiu")
          .classList.add("input-file-radius-opcional");
        //Limpiar Input Vacios
        for (
          var i = 0;
          i < document.querySelectorAll(".Hoja1_Archivos").length;
          i++
        ) {
      ...
      $scope.H1Limpiar_Campos_Req = function (HOJA) {
        angular.forEach(
          document.querySelectorAll("." + HOJA + "_Clase .red-text"),
          function (i) {
      ...
      $scope.Validar_CamposVacios = function (HOJA) {
        ...
        if (
          $scope[HOJA].Seccional_Cod == undefined ||
          $scope[HOJA].Seccional_Cod == null ||
          ($scope[HOJA].Seccional_Cod == "" &&
            $scope[HOJA].Municipio_Cod == undefined) ||
          $scope[HOJA].Municipio_Cod == null ||
          $scope[HOJA].Municipio_Cod == ""
        ) {
          Campos_Empty = true;
        }
        if (
          $scope[HOJA].Afi_Tipo_Doc == undefined ||
          $scope[HOJA].Afi_Tipo_Doc == null ||
          $scope[HOJA].Afi_Tipo_Doc == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Afi_Tipo_Doc_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Afi_Tipo_Doc_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Afi_Num_Doc == undefined ||
          $scope[HOJA].Afi_Num_Doc == null ||
          $scope[HOJA].Afi_Num_Doc == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Afi_Num_Doc_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Afi_Num_Doc_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        //
        if ($scope[HOJA].Actualizar_Datos == true && $scope[HOJA].Status == 1) {
          if (
            $scope[HOJA].Afi_Direccion == undefined ||
            $scope[HOJA].Afi_Direccion == null ||
            $scope[HOJA].Afi_Direccion == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#" + [HOJA] + "_Afi_Direccion_Label")
              .classList.add("red-text");
            document
              .getElementById([HOJA] + "_Afi_Direccion_Label")
              .scrollIntoView({ block: "start", behavior: "smooth" });
          }
          ...
          // }
          if (
            $scope.Form.Afi_Telefono_1.length > 0 &&
            $scope.Form.Afi_Telefono_1.length < 10 &&
            $scope.Form.Afi_Telefono_1.toString().replace(/[^0-9]/g, "")
              .length != 7
          ) {
            Campos_Empty = true;
            document
              .querySelector("#" + [HOJA] + "_Afi_Telefono_1_Label")
              .classList.add("red-text");
            document
              .getElementById([HOJA] + "_Afi_Telefono_1_Label")
              .scrollIntoView({ block: "start", behavior: "smooth" });
          }
          if ($scope.Form.Afi_Telefono_1.length > 0) {
            var Regex_Tel = new RegExp("^([1-9]{1})([0-9]{6})$");
            if (
              !Regex_Tel.test($scope.Form.Afi_Telefono_1.replace(/[^0-9]/g, ""))
            ) {
              Campos_Empty = true;
              document
                .querySelector("#" + [HOJA] + "_Afi_Telefono_1_Label")
          ...
          if (
            $scope[HOJA].Afi_Celular_1 == undefined ||
            $scope[HOJA].Afi_Celular_1 == null ||
            $scope[HOJA].Afi_Celular_1 == "" ||
            ($scope.Form.Afi_Celular_1.length > 0 &&
              $scope.Form.Afi_Celular_1.length < 16 &&
              $scope.Form.Afi_Celular_1.toString().replace(/[^0-9]/g, "")
                .length != 10)
          ) {
            Campos_Empty = true;
            document
              .querySelector("#" + [HOJA] + "_Afi_Celular_1_Label")
              .classList.add("red-text");
            document
              .getElementById([HOJA] + "_Afi_Celular_1_Label")
              .scrollIntoView({ block: "start", behavior: "smooth" });
          }
          if ($scope.Form.Afi_Celular_1.length > 0) {
            var Regex_Tel = new RegExp(
              "^([3]{1})([0-3]{1})([0-9]{1})([0-9]{7})$"
            );
            if (
              !Regex_Tel.test($scope.Form.Afi_Celular_1.replace(/[^0-9]/g, ""))
            ) {
              Campos_Empty = true;
              document
                .querySelector("#" + [HOJA] + "_Afi_Celular_1_Label")
          ...
          if (
            $scope.Form.Afi_Celular_2.length > 0 &&
            $scope.Form.Afi_Celular_2.length < 16 &&
            $scope.Form.Afi_Celular_2.toString().replace(/[^0-9]/g, "")
              .length != 10
          ) {
            Campos_Empty = true;
            document
              .querySelector("#" + [HOJA] + "_Afi_Celular_2_Label")
              .classList.add("red-text");
            document
              .getElementById([HOJA] + "_Afi_Celular_2_Label")
              .scrollIntoView({ block: "start", behavior: "smooth" });
          }
          if ($scope.Form.Afi_Celular_2.length > 0) {
            ...
            if (
              !Regex_Tel.test($scope.Form.Afi_Celular_2.replace(/[^0-9]/g, ""))
            ) {
              Campos_Empty = true;
              document
                .querySelector("#" + [HOJA] + "_Afi_Celular_2_Label")
        ...
        //
        if (
          $scope[HOJA].Op_Curso_Vida == undefined ||
          $scope[HOJA].Op_Curso_Vida == null ||
          $scope[HOJA].Op_Curso_Vida == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Op_Curso_Vida_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Op_Curso_Vida_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if ($scope[HOJA].Afi_Sexo == "F") {
          if (
            $scope[HOJA].Op_Gestacion == undefined ||
            $scope[HOJA].Op_Gestacion == null ||
            $scope[HOJA].Op_Gestacion == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#" + [HOJA] + "_Op_Gestacion_Label")
              .classList.add("red-text");
            document
              .getElementById([HOJA] + "_Op_Gestacion_Label")
              .scrollIntoView({ block: "start", behavior: "smooth" });
          }
          if (
            $scope[HOJA].Op_Fecha_Ultima_Men == undefined ||
            $scope[HOJA].Op_Fecha_Ultima_Men == null ||
            $scope[HOJA].Op_Fecha_Ultima_Men == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#" + [HOJA] + "_Op_Fecha_Ultima_Men_Label")
              .classList.add("red-text");
            document
              .getElementById([HOJA] + "_Op_Fecha_Ultima_Men_Label")
              .scrollIntoView({ block: "start", behavior: "smooth" });
          }
        }
        if (
          $scope[HOJA].Cod_Cohorte == undefined ||
          $scope[HOJA].Cod_Cohorte == null ||
          $scope[HOJA].Cod_Cohorte == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Cod_Cohorte_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Cod_Cohorte_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Cod_Diag == undefined ||
          $scope[HOJA].Cod_Diag == null ||
          $scope[HOJA].Cod_Diag == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Cod_Diag_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Cod_Diag_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Op_Necesidad == undefined ||
          $scope[HOJA].Op_Necesidad == null ||
          $scope[HOJA].Op_Necesidad == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Op_Necesidad_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Op_Necesidad_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Op_Seguimiento == undefined ||
          $scope[HOJA].Op_Seguimiento == null ||
          $scope[HOJA].Op_Seguimiento == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Op_Seguimiento_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Op_Seguimiento_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Op_Educaciones == undefined ||
          $scope[HOJA].Op_Educaciones == null ||
          $scope[HOJA].Op_Educaciones == "" ||
          $scope[HOJA].Op_Educaciones > 500
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Op_Educaciones_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Op_Educaciones_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Op_Observacion == undefined ||
          $scope[HOJA].Op_Observacion == null ||
          $scope[HOJA].Op_Observacion == "" ||
          $scope[HOJA].Op_Observacion > 1000
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Op_Observacion_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Op_Observacion_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (
          $scope[HOJA].Op_Fecha_Nuevo_Seg == undefined ||
          $scope[HOJA].Op_Fecha_Nuevo_Seg == null ||
          $scope[HOJA].Op_Fecha_Nuevo_Seg == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#" + [HOJA] + "_Op_Fecha_Nuevo_Seg_Label")
            .classList.add("red-text");
          document
            .getElementById([HOJA] + "_Op_Fecha_Nuevo_Seg_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
      ...
      $scope.Seleccionar_Criterio = function (Datos, Tipo) {
        ...
        var options = {};
        $.map(xArray, function (o) {
          options[o.id] = o.name;
        });
        swal({
          title:
            "Seleccione el criterio de " +
            (Tipo == "X" ? "Anulación" : "Aceptación"),
          input: "select",
      ...
      $scope.H1Guardar_Solicitud = function () {
        // console.log($scope.Form.Op_Fuente);
        var Campos_Empty = false;
        var Validar_Campos = [$scope.Validar_CamposVacios("Form")];
        $q.all(Validar_Campos).then(function (resultado) {
          Campos_Empty = resultado[0].campo;
          if (Campos_Empty == false) {
            if (document.getElementById("Form_Soporte1").value == "") {
              swal({
                title: "NOTIFICACION",
                type: "error",
              ...
              var Sel_Cri = [
                $scope.Seleccionar_Criterio(
                  $scope.Form.Op_Contesta_LLamada == true
                    ? "Array_Aceptacion"
                    : "Array_NoContesta",
                  "A"
                ),
                      ...
                      if (willDelete) {
                        ...
                        $q.all(Cargar_Soporte).then(function (Result_Sop) {
                          ...
                          for (var x = 0; x < Result_Sop.length; x++) {
                            if (
                              Result_Sop[x].substr(0, 3) == "<br" ||
                              Result_Sop[x].substr(0, 1) == "0" ||
                              (Result_Sop[x] == "" &&
                                $scope.Form.Soportes.Soporte1_B64 != "")
                            ) {
                              Archivos_Error = true;
                              swal({
                          ...
                          if (Archivos_Error == false) {
                            if (
                              $scope.Form.Op_Seguimiento == 1 ||
                              $scope.Form.Op_Seguimiento == 2
                            ) {
                              var xFecha_Nuevo_Seg =
                                $scope.Form.Op_Fecha_Nuevo_Seg;
                              var Fecha_Nuevo_Seg =
                                xFecha_Nuevo_Seg.getUTCDate() +
                                "-" +
                                (xFecha_Nuevo_Seg.getMonth() + 1 < 10
                                  ? "0" + (xFecha_Nuevo_Seg.getMonth() + 1)
                                  : xFecha_Nuevo_Seg.getMonth() + 1) +
                                "-" +
                                xFecha_Nuevo_Seg.getFullYear();
                            } else {
                              var Fecha_Nuevo_Seg = "";
                            }
                            ...
                            var Fecha_Inicio =
                              xFecha_Inicio.getUTCDate() +
                              "-" +
                              (xFecha_Inicio.getMonth() + 1 < 10
                                ? "0" + (xFecha_Inicio.getMonth() + 1)
                                : xFecha_Inicio.getMonth() + 1) +
                              "-" +
                              xFecha_Inicio.getFullYear();
                            var xFecha_Fin = $scope.Form.Fecha_Fin;
                            var Fecha_Fin =
                              xFecha_Fin.getUTCDate() +
                              "-" +
                              (xFecha_Fin.getMonth() + 1 < 10
                                ? "0" + (xFecha_Fin.getMonth() + 1)
                                : xFecha_Fin.getMonth() + 1) +
                              "-" +
                              xFecha_Fin.getFullYear();
                            var xFecha_Ultima_Men =
                              $scope.Form.Op_Fecha_Ultima_Men;
                            var Fecha_Ultima_Men =
                              xFecha_Ultima_Men.getUTCDate() +
                              "-" +
                              (xFecha_Ultima_Men.getMonth() + 1 < 10
                                ? "0" + (xFecha_Ultima_Men.getMonth() + 1)
                                : xFecha_Ultima_Men.getMonth() + 1) +
                              "-" +
                              xFecha_Ultima_Men.getFullYear();
                            ...
                            if (
                              $scope.Form.Cod_Cohorte != "EM" &&
                              $scope.Form.Afi_Sexo != "F" &&
                              $scope.Form.Op_Contesta_LLamada != true
                            ) {
                              Fecha_Ultima_Men = "";
                            }
                            var Datos = {
                              ...
                              Direccion:
                                $scope.Form.Afi_Direccion.toString().toUpperCase(),
                              Barrio:
                                $scope.Form.Afi_Barrio.toString().toUpperCase(),
                              Telefono_1:
                                $scope.Form.Afi_Telefono_1.toString().replace(
                                  /[^0-9]/g,
                                  ""
                                ),
                              Celular_1:
                                $scope.Form.Afi_Celular_1.toString().replace(
                                  /[^0-9]/g,
                                  ""
                                ),
                              Celular_2:
                                $scope.Form.Afi_Celular_2.toString().replace(
                                  /[^0-9]/g,
                                  ""
                                ),
                              Fuente: $scope.Form.Op_Fuente != '' ? $scope.Form.Op_Fuente : 'O',
                              ...
                              Estado_Accion: "P",
                              Actualizar_Datos: $scope.Form.Actualizar_Datos
                                ? "S"
                                : "N",
                              Contesta_Llamado: $scope.Form.Op_Contesta_LLamada
                                ? "S"
                                : "N",
                            };
      ...
      $scope.H1Anular_Solicitud = function () {
        var Campos_Empty = false;
        if (
          $scope.Form.Op_Observacion == undefined ||
          $scope.Form.Op_Observacion == null ||
          $scope.Form.Op_Observacion == ""
        ) {
          Campos_Empty = true;
          document
            .querySelector("#Form_Op_Observacion_Label")
            .classList.add("red-text");
          document
            .getElementById("Form_Op_Observacion_Label")
            .scrollIntoView({ block: "start", behavior: "smooth" });
        }
        if (Campos_Empty == false) {
          var Sel_Cri = [$scope.Seleccionar_Criterio("Array_Anulacion", "X")];
          $q.all(Sel_Cri).then(function (Criterio) {
            if (Criterio != "") {
              swal({
                title: "¿Está seguro que desea guardar?",
      ...
      $scope.Consultar_Afiliado = function (Accion) {
        ...
        if (Accion == "A") {
          angular.forEach(
            document.querySelectorAll("#Modal_ConsultarAfiliado .red-text"),
            function (i) {
              i.classList.remove("red-text");
            }
          );
          angular.forEach(
            document.querySelectorAll(".Form_Consulta input"),
            function (i) {
              // i.removeAttribute("readonly");
              i.setAttribute("readonly", true);
              // i.classList.add("class_gris");
          ...
          angular.forEach(
            document.querySelectorAll(".Form_Consulta select"),
            function (i) {
              i.setAttribute("disabled", true);
            }
          );
        ...
        if (Accion == "G") {
          var Campos_Empty = false;
          if (
            $scope.Modal_Consulta_Tipo == undefined ||
            $scope.Modal_Consulta_Tipo == null ||
            $scope.Modal_Consulta_Tipo == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#Modal_Consulta_Tipo_Label")
              .classList.add("red-text");
          }
          if (
            $scope.Modal_Consulta_Nombre == undefined ||
            $scope.Modal_Consulta_Nombre == null ||
            $scope.Modal_Consulta_Nombre == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#Modal_Consulta_Nombre_Label")
              .classList.add("red-text");
          }
          if (
            $scope.Modal_Consulta_Numero == undefined ||
            $scope.Modal_Consulta_Numero == null ||
            $scope.Modal_Consulta_Numero == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#Modal_Consulta_Numero_Label")
              .classList.add("red-text");
          }
          ...
          // }
          if (
            $scope.Modal_Consulta_Cod_Cohorte == undefined ||
            $scope.Modal_Consulta_Cod_Cohorte == null ||
            $scope.Modal_Consulta_Cod_Cohorte == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#Modal_Consulta_Cod_Cohorte_Label")
              .classList.add("red-text");
          }
          if (
            $scope.Modal_Consulta_Diagnostico_Cod == undefined ||
            $scope.Modal_Consulta_Diagnostico_Cod == null ||
            $scope.Modal_Consulta_Diagnostico_Cod == ""
          ) {
            Campos_Empty = true;
            document
              .querySelector("#Modal_Consulta_Cod_Diag_Label")
              .classList.add("red-text");
          }
      ...
      $scope.KeyFind_Afiliado = function (keyEvent) {
        if (keyEvent.which === 13) $scope.Buscar_Afiliado();
      };
      ...
      $scope.KeyFind_ObDiag = function (keyEvent) {
        if (keyEvent.which === 13) $scope.Buscar_Diag();
      };
        ...
        if ($scope.Modal_Consulta_Diagnostico.length > 2) {
          $http({
            ...
            if (response.data[0] != undefined && response.data.length > 1) {
              ...
              $(".Clase_Listar_Diags").css({
                width: $("#Gestion_Diag")[0].offsetWidth,
              });
            }
            if (response.data.length == 1) {
              if (response.data[0].DIAGNOSTICO == "-1") {
                ...
                $scope.FillTextbox_Listado_Diag(
                  response.data[0].DIAGNOSTICO,
                  response.data[0].DESCRIPCION,
                  response.data[0].COD_COHORTE
                );
              }
      ...
      $scope.Complete_Listado_Diag = function (string) {
        if (
          $scope.Modal_Consulta_Diagnostico != undefined &&
          string != undefined &&
          $scope.Busqueda.Diagnostico.Listado != undefined
        ) {
          $(".Clase_Listar_Diags").css({
            width: $("#Gestion_Diag")[0].offsetWidth,
          });
          ...
          angular.forEach($scope.Busqueda.Diagnostico.Listado, function (x) {
            if (
              x.DESCRIPCION.toUpperCase().indexOf(string.toUpperCase()) >= 0 ||
              x.DIAGNOSTICO.toString()
                .toUpperCase()
              ...
              output.push({
                ...
                COD_COHORTE: x.COD_COHORTE.toUpperCase(),
                NOM_COHORTE: x.NOM_COHORTE.toUpperCase(),
              });
            }
          });
      ...
      $scope.Blur_Diag = function () {
        setTimeout(() => {
          if (
            $scope.Modal_Consulta_Diagnostico != null &&
            $scope.Modal_Consulta_Diagnostico != undefined
          ) {
            if (
              $scope.Modal_Consulta_Diagnostico !=
                $scope.Busqueda.Diagnostico.SAVE &&
              $scope.Busqueda.Diagnostico.SAVE != null
            ) {
              $scope.Modal_Consulta_Diagnostico =
                $scope.Busqueda.Diagnostico.SAVE;
              $scope.Busqueda.Diagnostico.Filtro = null;
      ...
      $scope.Chg_Cohorte = function () {
        if (
          $scope.Busqueda.Diagnostico.Cohorte !=
          $scope.Modal_Consulta_Cod_Cohorte
        ) {
          $scope.Modal_Consulta_Diagnostico = "";
          $scope.Modal_Consulta_Diagnostico_Cod = "";
      ...
      $scope.Set_Educacion = function () {
        if ($scope.Form.Cod_Cohorte == "EM") {
          $scope.Form.Op_Educaciones =
            "Importancias del control prenatal, manejo de dieta, signos de alarma, cuidados del recién nacido. Medidas preventivas COVID.";
        }
        if ($scope.Form.Cod_Cohorte == "DM") {
          $scope.Form.Op_Educaciones =
            "Estilos de vida saludable, dieta, ejercicio adherencia al tratamiento. Signos de alarma. Medidas preventivas COVID.";
        }
        if ($scope.Form.Cod_Cohorte == "V1") {
          $scope.Form.Op_Educaciones =
            "Estilos de vida saludable, denunciar ante cualquier agresión, manejo de las emociones, pautas de autocuidado.";
        }
        if ($scope.Form.Cod_Cohorte == "DI") {
          $scope.Form.Op_Educaciones =
            "Estilos de vida saludable, pautas de autocuidado, adherencia al tratamiento, importancia de la rehabilitación.";
        }
        if ($scope.Form.Cod_Cohorte == "SM") {
          $scope.Form.Op_Educaciones =
            "Estilos de vida saludable manejo de las emociones, pautas de autocuidado, signos y síntomas de alerta.";
        }
        if ($scope.Form.Cod_Cohorte == "J9") {
          $scope.Form.Op_Educaciones =
            "Signos y síntomas de alarma, estilos de vida saludable, efectos.";
        }
        ...
        if ($scope.Form.Cod_Cohorte == "D1") {
          $scope.Form.Op_Educaciones =
            "TRASTORNOS NUTRICIONALES POR DEFICIENCIAS DE VITAMINAS.";
        }
        if ($scope.Form.Cod_Cohorte == "VC") {
          $scope.Form.Op_Educaciones =
            "Recibió educación sobre derechos y deberes, remisión a protocolo de atención en salud con enfoque diferencial. Educación sobre estilos de vida saludables y remisión a ruta de promoción y mantenimiento de acuerdo a curso de vida.";
        }
      };
        ...
        if ($scope.Form.Status == "1") {
          if (
            ...
            $http({
              ...
              $scope.Form.Op_Fecha_Nuevo_Seg = new Date(
                x[2] + "/" + x[1] + "/" + x[0]
              );
            });
            angular.forEach(
              document.querySelectorAll(".Form_Seg input"),
              function (i) {
                i.setAttribute("readonly", true);
              }
            );
        ...
        if (ValidarExistente != true) {
          if (fileInput.files.length != 0) {
            ...
            if (x[x.length - 1].toUpperCase() == "PDF") {
              if (fileInput.files.length > 0) {
                if (
                  fileInput.files[0].size < 10485760 &&
                  ...
                  $scope.getBase64(fileInput.files[0]).then(function (result) {
                    $http({
                      ...
                      $scope.Form[SOPORTE][SCOPE] =
                        response.data + "?page=hsn#toolbar=0";
                      if (SCOPE == "Soporte1_URL") {
                        setTimeout(function () {
                          document.querySelector("#Iframe_Sop1").style.width =
                            document.querySelector("#AdjustSop").offsetWidth -
                            6 +
                            "px";
                          $scope.$apply();
                        }, 200);
                        if (
                          document
                            .querySelector(".input-file-radiu")
                            .classList.contains("input-file-radius-opcional") ==
                          true
                        ) {
                          document
                            .querySelector(".input-file-radiu")
                            .classList.remove("input-file-radius-opcional");
                          document
                            .querySelector(".input-file-radiu")
                            .classList.add("input-file-radius-cargado");
                        }
                      } else {
                        setTimeout(function () {
                          angular.forEach(
                            ...
                            function (i) {
                              i.style.width =
                                document.querySelector("#AdjustSop2")
                                  .offsetWidth -
                                6 +
                                "px";
                            }
                  ...
                  swal(
                    "Advertencia",
                    "¡El archivo seleccionado excede el peso máximo posible (10MB)!",
                    "info"
                  );
                  fileInput.value = "";
                  ...
                  if (
                    document
                      .querySelector(".input-file-radiu")
                      .classList.contains("input-file-radius-cargado") == true
                  ) {
                    document
                      .querySelector(".input-file-radiu")
                      .classList.remove("input-file-radius-cargado");
              ...
              swal(
                "Advertencia",
                "¡El archivo seleccionado deber ser formato PDF!",
                "info"
              );
              fileInput.value = "";
              document.querySelector("#" + NIDT).value = "";
      ...
      $scope.Fuente_Color_Form = function (Fuente) {
        ...
        if (Fuente != "A" && Fuente != "R" && Fuente != "C" && Fuente != "N") {
          return "#6A6D71";
        }
      };
      ...
      $scope.Estado_Solicitud_Clase = function (Estado) {
        if (
          Estado.toString().toUpperCase() == "A" ||
          Estado.toString() == "1"
        ) {
          return "Con_pulse_P";
        }
        if (
          Estado.toString().toUpperCase() == "P" ||
          Estado.toString() == "2"
        ) {
          return "Con_pulse_A";
        }
        if (
          Estado.toString().toUpperCase() == "X" ||
          Estado.toString() == "3"
        ) {
          return "Con_pulse_X";
        }
      ...
      $scope.chg_filtrar = function (query) {
        $scope.filter(query);
      };
      ...
      $scope.obtenerFuente = function () {
        ...
        $http({
          ...
          $scope.arrayFuentes = [];
          $scope.arrayFuentes = data;
        });
      };

      $scope.obtenerListaMedicion = function () {
        swal({ title: "Cargando...", allowOutsideClick: false });
        swal.showLoading();
        $scope.listaMedicion = [];
        $http({
          ...
          const groupedData = {};
          data.forEach((item) => {
            const regionalKey = item.REGIONAL;
            if (!groupedData[regionalKey]) {
              groupedData[regionalKey] = {};
            }
            groupedData[regionalKey][item.NOM_ESTADO] =
              parseInt(item["CANTIDAD"]) ?? 0;
          });
          const result = Object.entries(groupedData).map(
            ([regionalKey, estados]) => {
              return { REGIONAL: regionalKey, ...estados };
            }
          );
          swal.close();
          $scope.listaMedicion = result;
          $(".tabs").tabs();
          $scope.tab = 1;
        });
      };
      ...
      $scope.setTab = function (x) {
        if ($scope.permisosUsu.INDICADORES == "S") {
          $scope.tab = x;
          if (x == 1) {
            $scope.obtenerListaMedicion();
          }
          if (x == 2) {
            $scope.ListaTablaIncidentes.length > 0
              ? null
              : $scope.Obtener_Datos("I");
          }
          if (x == 3) {
            $scope.ListaTablaPrevalentes.length > 0
              ? null
              : $scope.Obtener_Datos("P");
          }
        } else {
          if ($scope.pantalla == 2)
            swal({
      ...
      $scope.Obtener_Datos = function (tabla) {
        swal({ title: "Cargando...", allowOutsideClick: false });
        swal.showLoading();
        $scope.listaMedicion = [];
        $http({
          ...
          swal.close();
          if (tabla == "I") {
            $scope.ListaTablaIncidentes = data;
            $scope.ListaTablaIncidentesTemp = [...$scope.ListaTablaIncidentes];
          } else {
            $scope.ListaTablaPrevalentes = data;
            $scope.ListaTablaPrevalentesTemp = [
              ...$scope.ListaTablaPrevalentes,
            ];
          }
      ...
      $scope.verDetalle = function (x) {
        $scope.detalleAfiliado = x;
        $("#Modal_Detalle_afiliado").modal("open");
      };
      ...
      $scope.filtroAvanzado = function (
        ...
        if (
          ...
          const filteredArr = $scope.ListaTablaIncidentes.filter((obj) => {
            const fechaNovedadDate = new Date(obj.FECHA_NOVEDAD);
            return (
              fechaNovedadDate >= fechaInicioDate &&
              fechaNovedadDate <= fechaFinDate
            );
          });
          $scope.ListaTablaIncidentesTemp = filteredArr;
        } else if (
          (tipo_doc != undefined,
          documento != undefined &&
            fechaInicio == undefined &&
          ...
          const filteredArr = $scope.ListaTablaIncidentes.filter((obj) => {
            return obj.TIPO_DOC === tipo_doc && obj.DOCUMENTO === documento;
          });
          $scope.ListaTablaIncidentesTemp = filteredArr;
        } else {
          swal("Advertencia", "¡Seleccione solo 1 tipo de filtro!", "info");
        }
      };

      $scope.nombreFuente = function (id) {
        const nombre = $scope.cardsInformativas.find((f) => f.ID == id);
        return nombre ? nombre.NOMBRE : "??";
      };

      $scope.clasificacion_detalle = function (list) {
        $scope.arrayDetalleConsolidado = [];
        swal({ title: "Cargando...", allowOutsideClick: false });
        swal.showLoading();
        $http({
          method: "POST",
          ...
          data: {
            ...
            departamento: list.REGIONAL,
            estado: "A",
          },
        }).then(function (response) {
          if (
            response.data.toString().substring(0, 3) == "<br" ||
            response.data == 1
          ) {
            swal("NOTIFICACION", "¡Recargue la pagina por favor!", "info");
          } else {
            $scope.arrayDetalleConsolidado = response.data;
          }
        });
      };

      $scope.limpiarFiltro = function () {
        $scope.filtro.tipo_Doc = undefined;
        $scope.filtro.documento = undefined;
        $scope.filtro.fechaIni = undefined;
        $scope.filtro.fechaFin = undefined;
        $scope.ListaTablaIncidentesTemp = $scope.ListaTablaIncidentes;
      };
      ...
      $scope.obtenerPermisos = function () {
        $http({
          ...
          if (
            ...
            $scope.permisosUsu = response.data[0];
            $scope.permisosUsu.AREA = "GS";
            if ($scope.permisosUsu.VISUALIZAR == "N") {
              //   swal("Mensaje", "¡Usted no cuenta con permisos para acceder a este módulo, favor contactar a la Nacional!", "info");
