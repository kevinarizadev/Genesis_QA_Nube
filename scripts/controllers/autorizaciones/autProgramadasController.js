...
angular.module('GenesisApp')
  ...
  .controller('autProgramadasController', ['$scope', '$http', '$location', '$filter', 'ngDialog', '$timeout', 'pqrHttp', function ($scope, $http, $location, $filter, ngDialog, $timeout, pqrHttp) {
    ...
    $(document).ready(function () {
      ...
      var myInput = document.getElementById('justclinica');
              ...
              if ($scope.respuesta.Codigo == '1') {
                ...
                if ($scope.solicitudpro.ext) {
                  $http({
                    ...
                    var validacioncargue = myArray[1];
                    if(validacioncargue =='cargue_ftp'){
                      ...
                      swal('Importante', response.data, 'info');
                    }
                  })
                }
              } else {
    ...
    $scope.validartabI = function (tipo) {
      ...
      switch (tipo) {
        case 'solicitud':
          ...
          }else if($scope.solicitudpro.especialidadmedico == '' || $scope.solicitudpro.especialidadmedico == undefined){
            $scope.textvalidate = "Debe seleccionar Una Especialidad";
            $scope.pasarsolicitudautprog = false;
          }
