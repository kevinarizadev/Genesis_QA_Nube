        ...
        $http({
          ...
          if (response.data != undefined) {
            if (response.data[0] != undefined) {
              ...
              $scope.nombreSubdirector = 'APROBACIÓN DEL SUBDIRECTOR NACIONAL DE REDES DE PRESTADORES DE SERVICIOS DE SALUD';
              ...
              if ($scope.Ant_FECHA_PROCESADO >= $scope.Ajuste_Septiembre && $scope.Ant_FECHA_PROCESADO < $scope.Ajuste_Febrero_2023) {
                $scope.Ajuste_Mayo_D_S = 'Sub';
                $scope.numeroVersion = '04';
                $scope.fechaVersion = 'Junio 2022';
              }
              if ($scope.Ant_FECHA_PROCESADO >= $scope.Ajuste_Febrero_2023) {
                $scope.Ajuste_Mayo_D_S = 'Sub';
                $scope.numeroVersion = '01';
