...
$scope.ModalNumeroCelular = function () {
  ...
  $scope.datosafiliadoscitasautomaticas.Municipio == 'MAICAO' || $scope.datosafiliadoscitasautomaticas.Municipio == 'CARTAGENA' || $scope.datosafiliadoscitasautomaticas.Municipio == 'TUBARA' ||
  $scope.datosafiliadoscitasautomaticas.Municipio == 'SOGAMOSO' || $scope.datosafiliadoscitasautomaticas.Municipio == 'DIBULLA' || $scope.datosafiliadoscitasautomaticas.Municipio == 'VILLAVICENCIO'
  || $scope.datosafiliadoscitasautomaticas.Municipio == 'TUNJA')){
