        ...
        function ($scope, $http, consultaHTTP, $filter, ngDialog, cfpLoadingBar, afiliacionHttp) {
                    ...
                    $http({
                        ...
                        if ($scope.respuesta.codigo == '0') {
                            ...
                            if ($scope.respuesta[0].estado_documento == 'S') {
                                ...
                                swal('Notificacion', 'Actualmente El Cabeza No Tiene Documento De Identidad', 'info');
                                $scope.CargueCabeza = true;
                                $scope.OcultarTablaInformacion = false;
                                $scope.TipoReporte = false;
                                $scope.OcultarTipoReportes = false;
                                $scope.TipoReporte2 = true;
            ...
            $scope.RegistrarIncosistencia = function () {
                ...
                $http({
                    ...
                    url: "php/ips/func3047.php",
                    data: {
                        function: 'ReporteIncosistencia', tipo_documento: $scope.tipodocumento_cabeza,
