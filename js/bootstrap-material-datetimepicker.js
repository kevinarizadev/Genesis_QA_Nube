   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button style="color:white;" class="dtp-btn-now btn btn-flat hidden">' + this.params.nowText + '</button>' +
                         '<button style="color:white;" class="dtp-btn-clear btn btn-flat hidden">' + this.params.clearText + '</button>' +
                         '<button style="color:white;" class="dtp-btn-cancel btn btn-flat">' + this.params.cancelText + '</button>' +
                         '<button style="color:white;" class="dtp-btn-ok btn btn-flat">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
