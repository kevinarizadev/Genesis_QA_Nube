...
var ThemeSettings = {
    init: function() {
        this.defineUI(), this.restoreCookieSettings(), this.bindUIEvents(), this.hash.indexOf("disable-iframe") == -1 ? this.loadIframe() : this.window.hide()
    },
    defineUI: function() {
        $.extend(this, {
            constants: {
...
$(window).on("load", function() {
        window.disableThemeSettings !== !0 ? $("body").append($("<div/>").load(("undefined" != typeof angular ? "../" : "") + "Genesis/templates/themeSettings.html", function() {
            ThemeSettings.init()
