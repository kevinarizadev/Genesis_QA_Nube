<?php
    ...
    function obtener_gestionacasauditores(){
        ...
        global $param;
        $consulta = oci_parse($c,'BEGIN pq_genesis_acas.p_obtener_acas_cuentasmedicas(:v_jsonout_eps, :v_jsonout_ips); end;');
    ...
    function obteneracasmotivo_responsable(){
        require_once('../config/dbcon_prod.php');
        global $param;  
        $consulta = oci_parse($c, 'begin pq_genesis_acas.p_obtener_acas_motivo_rips(:v_pconcepto,
                                                                                        :v_ptipo,
                                                                                        :v_json_out); end;');
    ...
    function obteneracasconcepto(){
        require_once('../config/dbcon_prod.php');
        global $param;  
        $consulta = oci_parse($c, 'begin pq_genesis_acas.p_obtener_rips_persona(:v_pconcepto,
                                                                                        :v_pestado,
                                                                                        :v_ptipo,
                                                                                        :v_pcedula,
                                                                                        :v_json_out); end;');
