...
function P_BUSQUEDA_PRESTACIONES()
{
  ...
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_BUSQUEDA_PRESTACIONES(:v_valor,
                                                                                  :v_nit,
                                                                                  :v_json_row
                                                                                  ); end;');

  oci_bind_by_name($consulta, ':v_valor', $v_valor);
  oci_bind_by_name($consulta, ':v_nit', $codigo);
...
function P_LISTAR_ACTIVAS()
{
  ...
  global $request;
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTAR_ACTIVAS(:v_estado,
                                                                            :v_usuario,
                                                                            :v_json_row
                                                                            ); end;');
...
function P_LISTA_PRESTADORES()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTA_PRESTADORES(  :v_valor,
                                                                                :v_json_row
                                                                                ); end;');
...
function P_OBTENER_PERFIL()
{
  ...
  global $request;
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_PERFIL( :v_usuario,
                                                                            :v_json_row
                                                                            ); end;');
  oci_bind_by_name($consulta, ':v_usuario', $codigo);
  $clob = oci_new_descriptor($c, OCI_D_LOB);
...
function P_OBTENER_ESPECIALIDADES()
{
  ...
  global $request;
  $codigo = $request->codigo;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_ESPECIALIDADES(    :v_pcodigo,
                                                                                 :v_json_row
                                                                                 ); end;');
...
function P_OBTENER_EMPLEADOR()
{
  ...
  $nitempresa = $request->nitdeempresa;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_EMPLEADOR( :v_ptipodocumento,
                                                                                 :v_pdocumento,
                                                                                 :v_pnit,
                                                                                 :v_json_row
                                                                                 ); end;');
  ...
  oci_bind_by_name($consulta, ':v_pnit', $nitempresa);
  $clob = oci_new_descriptor($c, OCI_D_LOB);
  oci_bind_by_name($consulta, ':v_json_row', $clob, -1, OCI_B_CLOB);
  oci_execute($consulta, OCI_DEFAULT);
  if (isset($clob)) {
...
function P_BUSCAR_APORTANTE()
{
  ...
  $tipodocumento = $request->tipo_documento;
  $documento = $request->documento;
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_BUSCAR_APORTANTE( :v_ptipodocumento,
                                                                                 :v_pdocumento,
                                                                                 :v_json_row
                                                                                 ); end;');
  oci_bind_by_name($consulta, ':v_ptipodocumento', $tipodocumento);
...
function P_LISTA_CONCEPTO()
{
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTA_CONCEPTO(:v_json_row
                                                                            ); end;');
...
function p_lista_tipo_licencia()
{
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTA_TIPO_LICENCIA(:v_json_row
                                                                            ); end;');
...
function P_LISTA_CAUSALES()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTA_CAUSALES(
                                                                             :v_valor,
                                                                             :v_etapa,
                                                                             :v_json_row
                                                                            ); end;');
...
function P_LISTA_MOTIVO()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTA_MOTIVO(    :v_pconcepto,
                                                                                 :v_json_row
                                                                                 ); end;');
...
function P_LISTAR_GRAPICA_PIE()
{
  ...
  // $codigo =$request->concepto;
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTAR_GRAPICA_PIE( :v_pfecha_inicio,
                                                                                  :v_pfecha_fin,
                                                                                  :v_nit,
                                                                                  :v_json_row
                                                                                 ); end;');
...
function P_LISTA_ARCHIVOS()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTA_ARCHIVOS(    :v_documento,
                                                                                 :v_pconcepto,
                                                                                 :v_tipo_cot,
                                                                                 :v_numero,
                                                                                 :v_ubicacion,
...
function P_OBTENER_DATOS_BASICOS()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_DATOS_BASICOS(:v_ptipodocumento,
                                                                                    :v_pdocumento,
                                                                                    :v_pnit,
                                                                                    :v_pinicio,
                                                                                    :v_json_row
  ...
  oci_bind_by_name($consulta, ':v_ptipodocumento', $tipodocumento);
  oci_bind_by_name($consulta, ':v_pdocumento', $documento);
  oci_bind_by_name($consulta, ':v_pnit', $codigo);
...
function P_OBTENER_TUTELAS()
{
  ...
  $tipodocumento = $request->tipo_documento;
  $documento = $request->documento;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_TUTELAS(:v_ptipodocumento,
                                                                                    :v_pdocumento,
                                                                                    :v_json_row
                                                                                    ); end;');
  oci_bind_by_name($consulta, ':v_ptipodocumento', $tipodocumento);
...
function p_obtener_historial()
{
  ...
  $tipodocumento = $request->tipo_documento;
  $documento = $request->documento;
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_HISTORIAL(:v_ptipodocumento,
                                                                                    :v_pdocumento,
                                                                                    :v_json_row
                                                                                    ); end;');
  oci_bind_by_name($consulta, ':v_ptipodocumento', $tipodocumento);
...
function P_LISTAR_CANTIDAD_CONCEPTO()
{
  ...
  global $request;
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTAR_CANTIDAD_CONCEPTO(:v_nit,:v_json_row
                                                                                    ); end;');
  oci_bind_by_name($consulta, ':v_nit', $codigo);
  $clob = oci_new_descriptor($c, OCI_D_LOB);
  oci_bind_by_name($consulta, ':v_json_row', $clob, -1, OCI_B_CLOB);
...
function P_LISTAR_CANTIDAD_SECCIONAL()
{
  ...
  $fecha_fin = date('d/m/Y', strtotime($request->fecha_fin));
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_LISTAR_CANTIDAD_SECCIONAL(:v_pfecha_inicio,
                                                                                        :v_pfecha_fin,
                                                                                        :v_pnit,
                                                                                        :v_json_row
                                                                                         ); end;');
...
function subir_archivos()
{
  ...
  for ($i = 0; $i < count($archivos); $i++) {
		$name = $hora . '_' .  $archivos[$i]->codigo . '_' . $ubicacion.'.'.$archivos[$i]->ext;
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_INSERTAR_SOPORTES(:v_ubicacion,
                                                                                 :v_numero_documento,
                                                                                 :v_rutas,
                                                                                 :v_cantidad,
                                                                                 :v_res
...
//   $consulta = oci_parse($c,'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_INSERTAR_PRESTACION(:v_pubicacion,
...
function p_insertar_prestacion()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_INSERTAR_PRESTACION(:v_pubicacion,
                                                                                  :v_ptipo_doc_afiliado,
                                                                                  :v_pafiliado,
                                                                                  :v_pconcepto,
                                                                                  :v_pfecha,
                                                                                  ...
                                                                                  :v_pnumero,
                                                                                  :v_json_row); end;');
  oci_bind_by_name($consulta, ':v_pubicacion', $request->ubicacionafi);
  oci_bind_by_name($consulta, ':v_ptipo_doc_afiliado', $request->tipo_documento);
  oci_bind_by_name($consulta, ':v_pafiliado', $request->documento);
  oci_bind_by_name($consulta, ':v_pconcepto', $request->concepto);
  oci_bind_by_name($consulta, ':v_pfecha', $request->fecha);
  ...
  oci_bind_by_name($consulta,':v_pnumero',$request->numeroradicado);
...
function validar_radi_subir_archivos()
{
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.p_tarea_adjunto(:v_pnumero_documento,:v_pubicacion,:v_json_row); end;');
  oci_bind_by_name($consulta, ':v_pnumero_documento', $request->numero);
...
function obtenerdiagnostico()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_DIAGNOSTICO(:v_pcoincidencia,:v_psexo,:v_pedad,:v_json_row); end;');
...
function P_INSERTA_MESA_AYUDA()
{
  ...
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_INSERTA_MESA_AYUDA(:v_ubicacion,
        :v_tipo_doc,
        :v_documento,
        :v_nombre_aportante,
        :v_tipo_doc_afil,
...
function p_insertar_val_liquida()
{
  ...
  // }
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_INSERTAR_VAL_LIQUIDA(:v_ubicacion,
                                                                                  :v_numero,
                                                                                  :v_causal,
                                                                                  :v_ibc,
                                                                                  :v_valor,
...
//   $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_INSERTAR_VAL_MEDICA(:v_ubicacion,
//                                                                                   :v_numero,
//                                                                                   :v_aprobada,
//                                                                                   :v_prorroga,
//                                                                                   :v_num_pro,
...
function p_mostrar_radicado()
{
  ...
  $codigo = $_SESSION['nit'];
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_MOSTRAR_RADICADO(:v_pnumero,
                                                                            :v_pradicado,
                                                                            :v_pubicacion,
                                                                            :v_pconcepto,
                                                                            :v_pnit,
...
//   require_once('../config/dbcon_prod.php');
//   global $request;
//   $consulta = oci_parse($c,'BEGIN PQ_GENESIS_PRESTACIONES_emp.p_lista_causal(:v_documento,
//                                                                          :v_numero,
//                                                                          :v_pubicacion,
//                                                                          :v_response); end;');
...
function p_actualiza_prestacion()
{
  ...
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_ACTUALIZA_PRESTACION(:v_numero,
                                                                                :v_ubicacion,
                                                                                :v_f_inicio,
                                                                                :v_duracion,
                                                                                :v_res
...
function p_reversar()
{
  ...
  global $request;
  $usuario = $_SESSION['cedula'];
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES_emp.P_REVERSAR_PRESTACION(:v_numero,
                                                                                  :v_ubicacion,
                                                                                  :v_usuario,
                                                                                  :v_response
                                                                                  ); end;');
...
function DatosElic(){
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'begin oasis.PQ_GENESIS_PRESTACIONES_emp.P_OBTENER_DATOS_APORTE(:v_tipo_documento,
  :v_numero_documento,
...
function OBTENER_DATOS_DEL_CALCULO(){
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_valida_salario_variable(:V_PTIPO_DOC,:V_PNUMERO,:v_finicio_incapacidad,:v_documento_aportante,:v_json_row); end;');
...
function OBTENER_DATOS_DEL_CALCULO_LINCENCIA(){
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.P_CALCULO_VARIABLES_LICENCIAS_BASE40(:V_PTIPO_DOC,:v_pnumero,:v_pfinicio_incapacidad,:v_pdocumento_aportante,:v_pjson_row); end;');
  oci_bind_by_name($consulta, ':V_PTIPO_DOC', $request->tipodocumento);
  oci_bind_by_name($consulta, ':v_pnumero', $request->documento);
...
function DATOS_PRORROGA(){
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN oasis.PQ_GENESIS_PRESTACIONES_emp.p_ibc_prorroga(:v_pnumero,:v_pjson_row); end;');
