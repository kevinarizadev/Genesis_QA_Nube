...
function ConsultarCertificado(){
  ...
  $consulta = oci_parse($c,'begin oasis.pq_genesis_prestaciones_emp.p_certificado_prestaciones(:v_tipo,:v_afiliado,:v_fecha_inicial,:v_fecha_final,:v_empresa,:v_json_out); end;');
...
function p_validacion_certificado(){
  ...
  $inicial = $request->inicial;
  $final = $request->final;
  $consulta = oci_parse($c,'begin oasis.pq_genesis_prestaciones_emp.p_validacion_certificado(:v_tipo,:v_afiliado,:v_fecha_inicial,:v_fecha_final,:v_json_out); end;');
  oci_bind_by_name($consulta,':v_tipo',$tipo);
  oci_bind_by_name($consulta,':v_afiliado',$documento);
  oci_bind_by_name($consulta,':v_fecha_inicial',$inicial);
  oci_bind_by_name($consulta,':v_fecha_final',$final);
