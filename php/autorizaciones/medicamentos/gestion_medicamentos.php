<?php
    ...
    function listar_departamento(){
        ...
        $estado = $param->estado;
        $consulta = oci_parse($c,'begin PQ_GENESIS_MEDICAMENTOS.P_LISTA_DEPARTAMENTOS_MED(:v_ubicacion,:v_estado,:v_json_res); end;');
   ...
   function listar_autorizaciones_ips(){
    ...
    function buscar_autorizacion_ips(){
        ...
        $nit = $param->nit;
        $numero_aut = $param->numero_aut;
        $consulta = oci_parse($c,'begin PQ_GENESIS_MEDICAMENTOS.P_OBTENER_AUTORIZACION_IPS(:v_pubicacion,:v_pnit,:v_numero_aut,:v_cursor); end;');
        oci_bind_by_name($consulta,':v_pubicacion',$ubicacion);
        oci_bind_by_name($consulta,':v_pnit',$nit);
        oci_bind_by_name($consulta,':v_numero_aut',$numero_aut);
