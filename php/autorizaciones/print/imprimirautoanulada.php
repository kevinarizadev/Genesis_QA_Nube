...
function obtenerautorizacion_web()
{
  ...
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_AUT.P_OBTENER_AUTORIZACION_WEB_ANULADA(:v_pnumero,:v_pubicacion,:v_json_row); end;');
...
function p_imprimir_autorizacion_web(){
	...
	$consulta = oci_parse($c,'BEGIN PQ_GENESIS_AUT.P_IMPRIMIR_AUTORIZACION_WEB_ANULADA(:v_pautorizacion,
																		  :v_json_row); end;');
