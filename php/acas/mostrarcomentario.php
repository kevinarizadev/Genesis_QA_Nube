<?php
	...
	$consulta = oci_parse($c,'begin PQ_GENESIS_ACAS.P_OBTENER_COMENTARIOS(:v_pdocumento,:v_tipo_acas,:v_pnumero,:v_pubicacion,:v_json_row); end;');
	// Asignamos los valores a los parametros
	oci_bind_by_name($consulta,':v_pdocumento',$documento);
	oci_bind_by_name($consulta,':v_tipo_acas',$codigo_concepto);
