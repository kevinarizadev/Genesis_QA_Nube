<?php
	...
	$consulta = oci_parse($c,'begin PQ_GENESIS_ACAS.P_ACTUALIZA_CORREO_CEL(:v_pdocumento,:v_pcorreo,:v_pcelular,:v_prespuesta); end;');
	// Asignamos los valores a los parametros
	oci_bind_by_name($consulta,':v_pdocumento',$documento);
	oci_bind_by_name($consulta,':v_pcorreo',$correo);
	oci_bind_by_name($consulta,':v_pcelular',$contacto);
