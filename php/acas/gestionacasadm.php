<?php
    ...
    function obtener_gestionacasauditores(){
		...
		global $param;
		$consulta = oci_parse($c,'BEGIN PQ_GENESIS_INVENTARIO_ADM.p_obtener_acas_administratva(:v_jsonout_eps, :v_jsonout_ips); end;');
    ...
    function obteneracasmotivo_responsable(){
        require_once('../config/dbcon_prod.php');
        global $param;  
        $consulta = oci_parse($c, 'begin PQ_GENESIS_INVENTARIO_ADM.p_obtener_acas_concepto_adm(:v_pconcepto,
                                                                                        :v_ptipo,
                                                                                        :v_json_out); end;');
    ...
    function obteneracasconcepto(){
        require_once('../config/dbcon_prod.php');
        global $param;  
        $consulta = oci_parse($c, 'begin PQ_GENESIS_INVENTARIO_ADM.p_obtener_acas_adm_persona(:v_pconcepto,
                                                                                        :v_pestado,
                                                                                        :v_ptipo,
                                                                                        :v_pcedula,
                                                                                        :v_json_out); end;');
