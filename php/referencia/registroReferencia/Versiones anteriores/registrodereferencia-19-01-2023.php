...
function insertReferencia()
{
	...
	:v_pdiagnostico1 ,:v_pservicio,:v_pservicio2,:v_pservicio3,:v_pfecha_recepcion,:v_pips_solicitante ,:v_pdoc_solicitante,:v_pcargo_solicitante ,:v_ptelefono,:v_json_row); end;');
	oci_bind_by_name($consulta, ':v_pdocumento', $request->pdocumento);
