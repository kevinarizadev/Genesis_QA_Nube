...
from pqr_solicitud p
inner join pqr_medio x on x.pqrn_codigo_medio =  p.mediorecepcion
inner join pqr_secundario z on z.pqr_codigo =  z.pqr_documento_remitente and
p.estado = 'A'  and z.pqr_fase = 'G'
inner join bter_tercero b on b.terv_codigo = z.pqr_documento_remitente");
