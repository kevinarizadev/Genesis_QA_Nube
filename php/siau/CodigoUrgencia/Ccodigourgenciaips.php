<?php
  ...
  $request = json_decode($postdata);
	...
	function insertarurgencia(){
		...
		:v_pfechaingreso,:v_prol,:v_phijo,:v_pruta,:v_paccion,:v_pnegacion,:v_pmotivo_rechazo,:v_pcontrol,:v_pinformacion); end;');
		...
		oci_bind_by_name($consulta,':v_pcontrol',$control);
