...
$function();
	...
	function obtenerseccionales(){
		...
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_OFICINA_ADM(:v_cod,:v_json_row); end;');
	...
	function obtenernumeros(){
		require_once('../config/dbcon_prod.php');
		global $request;
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_NUMEROS(:v_json_row); end;');
	  $clob = oci_new_descriptor($c,OCI_D_LOB);
		oci_bind_by_name($consulta, ':v_json_row', $clob,-1,OCI_B_CLOB);
		oci_execute($consulta,OCI_DEFAULT);
		if (isset($clob)) {
	...
	function obteneroficina(){
		...
		$id = $request->id;
		$con = $request->con;
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_ESTADO(:v_pid,:v_con,:v_json_row); end;');
    ...
    function guardarhistorico_detalle(){
		...
		$hoy=date("d/m/Y");
		$json = $request->json;
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OFICINA_HISTORICO_DETALLE(:vp_id,:vp_con,:vp_fecha,:vp_resp,:vp_dir,:vp_arrenda,:vp_nit,
    ...
    function guardarhistorico_implementos(){
		...
		$hoy=date("d/m/Y");
		$json = $request->json;
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OFICINA_HISTORICO_IMPLEMENTOS(:vp_id,:vp_con,:vp_fecha,:vp_resp,:vp_cpuesto,:vp_epuesto,:vp_ccaunter,:vp_ecaunter,:vp_csillae,:vp_esillae,:vp_carchivadorp,:vp_earchivadorp,:vp_carchivadorr,
    ...
    function actualizarseccional_detalle(){
		...
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_ACTUALIZAR_OFICINA_DETALLE(:vp_id,:vp_con,:vp_dir,:vp_arrenda,:vp_nit,:vp_fec_ape,:vp_dura,:vp_venc,:vp_notif,:vp_valor,
	...
	function actualizarseccional_implementos(){
		...
		$con = $request->con;
		$json = json_decode($request->json);
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_ACTUALIZAR_OFICINA_IMPLEMENTOS(:vp_id,:vp_con,:vp_cpuesto,:vp_epuesto,:vp_ccaunter,:vp_ecaunter,:vp_csillae,:vp_esillae,:vp_carchivadorp,
	...
	function ObtenerHistorico_Detalle(){
		...
		$con = $request->con;
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_ARCHIVOS_HISTORIAL_DETALLE(:vp_seccional,:vp_con,:v_json_row); end;');
	...
	function ObtenerHistorico_Implementos(){
		...
		$seccional = $request->seccional;
		$con = $request->con;
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_ARCHIVOS_HISTORIAL_IMPLEMENTOS(:vp_seccional,:vp_con,:v_json_row); end;');
		oci_bind_by_name($consulta,':vp_seccional',$seccional);
		oci_bind_by_name($consulta,':vp_con',$con);
		$clob = oci_new_descriptor($c,OCI_D_LOB);
		oci_bind_by_name($consulta, ':v_json_row', $clob,-1,OCI_B_CLOB);
...
////////////////////////SUBIR ADJUNTOS////////////////////////////////
	function adjuntararchivos(){
		...
		$url = $request->url;
		$hoy=date("d/m/Y");
		$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_ADJUNTAR_ARCHIVOS(:vp_seccional,:vp_con,:vp_tipoarchivo,:vp_url,:vp_fecha,:vp_resp,:vp_json_row); end;');
		oci_bind_by_name($consulta,':vp_seccional',$seccional);
		oci_bind_by_name($consulta,':vp_con',$con);
...
function ObtenerAdjuntosAnio(){
	...
	$seccional = $request->seccional;
	$con = $request->con;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_ADJUNTOS_ANIO(:vp_seccional,:vp_con,:v_json_row); end;');
	oci_bind_by_name($consulta,':vp_seccional',$seccional);
	oci_bind_by_name($consulta,':vp_con',$con);
	$clob = oci_new_descriptor($c,OCI_D_LOB);
	oci_bind_by_name($consulta, ':v_json_row', $clob,-1,OCI_B_CLOB);
...
function ObtenerAdjuntosMes(){
	...
	$anio = $request->anio;
	$tipo = $request->tipo;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_ADJUNTOS_MES(:vp_seccional,:vp_con,:vp_anio,:vp_tipo,:v_json_row); end;');
	oci_bind_by_name($consulta,':vp_seccional',$seccional);
	oci_bind_by_name($consulta,':vp_con',$con);
...
function ObtenerAdjuntosDia(){
	...
	$tipo = $request->tipo;
	$mes = $request->mes;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_ADJUNTOS_DIA(:vp_seccional,:vp_con,:vp_anio,:vp_tipo,:vp_mes,:v_json_row); end;');
	oci_bind_by_name($consulta,':vp_seccional',$seccional);
	oci_bind_by_name($consulta,':vp_con',$con);
	oci_bind_by_name($consulta,':vp_anio',$anio);
	oci_bind_by_name($consulta,':vp_tipo',$tipo);
...
function actualizarfvencimiento(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.F_ACTUALIZAR_FVENCIMIENTO(:v_json,:v_cantidad,:v_json_row); end;');
...
function Obtener_Dptos_Mncpos(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_LISTAR_DPTOS_MNCPS(:VP_COINC,:VP_TIPO,:VP_JSON_ROW); end;');
...
function Registrar_Oficina(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_REGISTRAR_OFICINA(:VP_UBICACION,:VP_NOMBRE,:VP_TIPO,:VP_JSON_ROW); end;');
...
function Consultar_Oficina(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_LIST_OFICINA(:VP_ESTADO,:VP_JSON_ROW); end;');
...
function Activar_Inactivar_Of(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_ACT_DES_OFICINA(:VP_UBICACION,:VP_CONC,:VP_ACCION,:VP_JSON_ROW); end;');
	oci_bind_by_name($consulta,':VP_UBICACION',$request->Ubicacion);
...
function Desactivar_Imagenes(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_INAC_FOTOS(:VP_SECC,:VP_CONS,:VP_JSON,:VP_CANTIDAD,:VP_JSON_ROW); end;');
...
function Obtener_Correos(){
	require_once('../config/dbcon_prod.php');
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_OBTENER_CORREOS(:VP_JSON_ROW); end;');
	$clob = oci_new_descriptor($c,OCI_D_LOB);
	oci_bind_by_name($consulta, ':VP_JSON_ROW', $clob,-1,OCI_B_CLOB);
	oci_execute($consulta,OCI_DEFAULT);
	if (isset($clob)) {
...
function Actualizar_Correos(){
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c,'BEGIN oasis.PQ_GENESIS_GESTION_ADM.P_ACTUALIZAR_CORREOS(:VP_JSON,:VP_CANTIDAD,:VP_JSON_ROW); end;');
	oci_bind_by_name($consulta,':VP_JSON',$request->xdata);
	oci_bind_by_name($consulta,':VP_CANTIDAD',$request->Cantidad);
	$clob = oci_new_descriptor($c,OCI_D_LOB);
	oci_bind_by_name($consulta, ':VP_JSON_ROW', $clob,-1,OCI_B_CLOB);
