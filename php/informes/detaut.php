...
$consulta = oci_parse($c, "SELECT a.num_autorizacion, a.seccional,a.tipo_documento,
 ...
 a.DIAS_HAB_ORDEN_VS_SOLICITUD dias_orden_sol,
 a.DIAS_HAB_SOLICITUD_VS_AUTO dias_sol_aut, 
 a.nit_pss, a.razon_social, a.nit_solicitante, a.ubicacion_ter, a.razon_solial_ips_solicitante,  
 a.codigo_municipio, a.codigo_dpto_afiliado,
 ...
 AND ((to_number(a.codigo_dpto_afiliado) = case when length(:codmunicipio)=5 then substr(:codmunicipio,1,2) else substr(:codmunicipio,1,1)END) or (:codmunicipio = 1))");
//AND ROWNUM <= 1000");
//   WHERE a.año = 2020
...
var_dump($_SESSION['codmunicipio']);
?>
...
<table cellspacing="0" cellpadding="0" border="1" align="center">
   ...
   while ($rows = oci_fetch_assoc($consulta)) {
      ...
      echo "</td>";
      echo "<td>";
      echo $rows['AUTN_AUTORIZACION_MANUAL'];
      echo "</td>";
      echo "<td>";
      echo $rows['FECHA_ORDEN'];
      echo "</td>";
      echo "<td>";
      echo $rows['FECHA_SOLICITUD'];
      echo "</td>";
      echo "<td>";
      echo $rows['FECHA_PROCESADO'];
      echo "</td>";
      //echo "<td>"; echo$rows['FECHA_PRESTACION']; echo "</td>";
      echo "<td>";
      echo $rows['DIAS_ORDEN_SOL'];
      echo "</td>";
      echo "<td>";
      echo $rows['DIAS_SOL_AUT'];
      echo "</td>";
      echo "<td>";
      echo $rows['NIT_PSS'];
      echo "</td>";
      echo "<td>";
      echo $rows['RAZON_SOCIAL'];
      echo "</td>";
      echo "<td>";
      echo $rows['NIT_SOLICITANTE'];
      echo "</td>";
      echo "<td>";
      echo $rows['UBICACION_TER'];
      echo "</td>";
      echo "<td>";
      echo $rows['RAZON_SOLIAL_IPS_SOLICITANTE'];
      echo "</td>";
      echo "<td>";
      echo $rows['CODIGO_MUNICIPIO'];
      echo "</td>";
      echo "<td>";
      echo $rows['CODIGO_DPTO_AFILIADO'];
      echo "</td>";
      echo "<td>";
      echo $rows['NOMBRE_DPTO_AFILIADO'];
      echo "</td>";
      echo "<td>";
      echo $rows['MUNICIPIO_AFILIADO'];
      echo "</td>";
      echo "<td>";
      echo $rows['COD_CLASIFICACION'];
      echo "</td>";
      echo "<td>";
      echo $rows['NOMBRE_CLASIFICACION'];
      echo "</td>";
      echo "<td>";
      echo $rows['UNIDAD_FUNCIONAL'];
      echo "</td>";
      echo "<td>";
      echo $rows['COD_DX'];
      echo "</td>";
      ...
      echo "</td>";
      echo "<td>";
      echo $rows['VALOR_UNITARIO'];
      echo "</td>";
      echo "<td>";
      echo $rows['VALOR_SERVICIO'];
      echo "</td>";
      echo "<td>";
      echo $rows['COPAGO'];
      echo "</td>";
      echo "<td>";
      echo $rows['DOC_RESPONSABLE_AUT'];
      echo "</td>";
      echo "<td>";
      echo $rows['NOMBRE_RESPONSABLE'];
      echo "</td>";
      echo "<td>";
      echo $rows['ESTADO'];
      echo "</td>";
      ...
      echo "</td>";
      echo "<td>";
      echo $rows['UBICACION_SOLICITUD'];
      echo "</td>";
      echo "<td>";
      echo $rows['AUTN_SINIESTRO'];
      echo "</td>";
      echo "<td>";
      echo $rows['AUTC_REGIMEN'];
      echo "</td>";
      echo "<td>";
      echo $rows['PROC_COPAGO'];
      echo "</td>";
      echo "<td>";
      echo $rows['AUTN_NIVEL_CONTRIBUTIVO'];
      echo "</td>";
      echo "</tr>";
