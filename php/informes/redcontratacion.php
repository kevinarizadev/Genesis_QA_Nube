...
<?php
 $consulta = oci_parse($c, 'begin P_RED_CONTRATACION_CON_SERV(   :V_PANNO,
  :V_PPERIODO,
  :v_json_out,
  :v_result); end;');
  ...
  while (($row = oci_fetch_array($curs, OCI_ASSOC + OCI_RETURN_NULLS)) != false)
{
          echo "<tr>";
                        ...
                        echo "<td>"; echo$row['NOMBRE_TARIFA']; echo "</td>";
                        echo "<td>"; echo$row['OPERADOR']; echo "</td>";
                        echo "<td>"; echo$row['PORCENTAJE']; echo "</td>";
                        echo "<td>"; echo$row['TARIFA_CLASIFICACION']; echo "</td>";
                     ...
                     //   echo "<td>"; echo$row['CLASE']; echo "</td>";
                        ...
                        echo "<td>"; echo$row['BITC_OBSERVACION']; echo "</td>";
