...
header("Content-Disposition: attachment; filename=REPORTE CONTRATACION RED SIN SERVICIO"."_".date("dmY").".xls");
...
<h1>REPORTE CONTRATACION RED SIN SERVICIOS</h1>
...
$consulta = oci_parse($c, 'begin P_RED_CONTRATACION_SIN_SERV(   :V_PANNO,
:V_PPERIODO,
:v_json_out,
:v_result); end;');
...
while (($rows = oci_fetch_array($curs, OCI_ASSOC + OCI_RETURN_NULLS)) != false) 
{
            echo "<tr>";
                        ...
                        echo "<td>"; echo$rows['NOMBRE_UBICACION']; echo "</td>";

                        echo "<td>"; echo$rows['COD_MUNICIPIO']; echo "</td>";
                        echo "<td>"; echo$rows['NOMBRE_MUNICIPIO']; echo "</td>";

                        echo "<td>"; echo$rows['NIT']; echo "</td>";
                        echo "<td>"; echo$rows['COD_HABILITACION']; echo "</td>";
                        echo "<td>"; echo$rows['NOMBRE_PRESTADOR']; echo "</td>";
                        echo "<td>"; echo$rows['NUMERO_CONTRATO']; echo "</td>";
                        echo "<td>"; echo$rows['F_ELABORACION']; echo "</td>";

                        echo "<td>"; echo$rows['NATURALEZA']; echo "</td>";
                        ...
                        echo "<td>"; echo$rows['UPC_AFILIADOS']; echo "</td>";
                        echo "<td>"; echo$rows['NO_AFILIADOS']; echo "</td>";
                        echo "<td>"; echo$rows['VALOR_CONTRATO']; echo "</td>";
                        echo "<td>"; echo$rows['FECHA_INICIAL']; echo "</td>";
                        echo "<td>"; echo$rows['FECHA_FINAL']; echo "</td>";
                        echo "<td>"; echo$rows['NIVEL_ATENCION_CONTRATO']; echo "</td>";
                    
                        echo "<td>"; echo$rows['ESTADO']; echo "</td>";
                        echo "<td>"; echo$rows['TAREA']; echo "</td>";
                        echo "<td>"; echo$rows['BITC_OBSERVACION']; echo "</td>";
