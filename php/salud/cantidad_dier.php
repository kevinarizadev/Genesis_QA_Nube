<?php
	...
	$consulta = oci_parse($c,"SELECT  (SELECT count(1) from r_traza_rips_20162_diag) as TOTAL, 
              (SELECT count(1) from r_traza_rips_20162_diag where diagnostico_nuevo is not null) as REALIZADO from dual");	
