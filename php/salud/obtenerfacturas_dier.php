<?php
	...
	$consulta = oci_parse($c,"SELECT  * FROM (SELECT * from r_traza_rips_20162_diag where diagnostico_nuevo is null and rownum <= 10 order by edad) order by dbms_random.value");	
