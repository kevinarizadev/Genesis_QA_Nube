<?php
    ...
    function obtener_gestionacasauditores(){
		...
		global $param;
		$consulta = oci_parse($c,'BEGIN pq_genesis_censo_hospitalario.P_OBTENER_ACAS_AUDITORIA_SALUD(:v_jsonout_eps, :v_jsonout_ips); end;');
    ...
    function obteneracasmotivo_responsable(){
        require_once('../config/dbcon_prod.php');
        global $param;  
        $consulta = oci_parse($c, 'begin pq_genesis_censo_hospitalario.p_obtener_acas_motivo(:v_pmotivo,
                                                                                        :v_ptipo,
                                                                                        :v_json_out); end;');
    ...
    function obteneracasconcepto(){
        require_once('../config/dbcon_prod.php');
        global $param;  
        $consulta = oci_parse($c, 'begin pq_genesis_censo_hospitalario.p_obtener_acas_motivo_persona(:v_pmotivo,
                                                                                        :v_pestado,
                                                                                        :v_ptipo,
                                                                                        :v_cedula,
                                                                                        :v_json_out); end;');
