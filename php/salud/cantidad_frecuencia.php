<?php
	...
	$consulta = oci_parse($c,"SELECT  (select count(1) from r_traza_rips_20162_frecval) as TOTAL, 
              (select count(1) from r_traza_rips_20162_frecval r where r.observacion is not null) as REALIZADO from dual");	
