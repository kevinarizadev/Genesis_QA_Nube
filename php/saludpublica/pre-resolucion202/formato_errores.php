...
header("Content-Disposition: attachment; filename=Reporte Errores " .$rad.'_'. date("d_m_Y") . ".xls");
...
$consulta = oci_parse($c, 'BEGIN oasis.pq_genesis_202.p_lista_errores_cargue(:v_pcodigo_proceso,:v_json_row); end;');
