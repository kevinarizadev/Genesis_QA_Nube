...
function CargueHistorico_Portabilidad()
{
	// este sp se recibe un cursor
	require_once('../../config/dbcon.php');
	$consulta = oci_parse($c, 'BEGIN pq_genesis_po.listar_historico_portabilidad(:v_historico_po );end;');
	$clob = oci_new_descriptor($c, OCI_D_LOB);
	$cursor = oci_new_cursor($c);
	oci_bind_by_name($consulta, ':v_historico_po', $cursor, -1, OCI_B_CURSOR);
...
function Cargue_Historico_Portabilidad()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_IMPORTAR_HISTORICO_PORTABILIDAD/payload/' . $tokens . '/submit',
		CURLOPT_ENCODING => '',
...
function Edad_Cartera_Vigente()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_Edad_Cartera_Vigente/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Gen_Reservas_Tecnicas()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_GenReservas_Tecnicas/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Historico_Contratacion()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_Reporte_Contratacion/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Cargue_facturasProcesadas()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_Re__Facturas_Procesadas/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
{
	var_dump('ksajdlkajslkdjaslkdjlasjdlkasjlkdjaslkjdlasjkda');
	$tokens = $_SESSION['tokens'];
	$username =  'secureForm';
	$password = 'Cajacopi1#';
	$curl = curl_init();
