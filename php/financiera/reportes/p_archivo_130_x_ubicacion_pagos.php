...
header("Content-Disposition: attachment; filename=Reporte_archivo_130_x_ubicacion_pagos- " . "_" . date("d_m_Y") . ".txt");
...
$consulta = oci_parse($c, 'begin pq_genesis_repo.p_archivo_130_x_ubicacion_pagos(           :v_pempresa,
                                                                                                 :v_pregimen,
                                                                                                 :v_panno,
                                                                                                 :v_pperiodo,
                                                                                                 :v_pciclo,
