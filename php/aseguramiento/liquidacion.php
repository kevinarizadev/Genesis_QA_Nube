...
function subir_archivos()
{
  ...
  oci_bind_by_name($consulta, ':v_pnumero_documento', $numerora);
...
function validar_radi_subir_archivos()
{
  require_once('../config/dbcon_prod.php');
  global $request;
  $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_PRESTACIONES.p_tarea_adjunto(:v_pnumero_documento,:v_pubicacion,:v_json_row); end;');
  oci_bind_by_name($consulta, ':v_pnumero_documento', $request->numero);
