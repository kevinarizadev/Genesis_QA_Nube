...
//var_dump($row);
{
          ...
          echo "<td>"; echo$row['FECHA_DE_ACEPTACION'].' - '.$row['HORA']; echo "</td>";
          ...
          echo "<td>"; echo$row['FECHA_GESTION'].' - '.$row['HORA_GESTION']; echo "</td>";
          ...
          echo "<td>"; echo$row['HABILITACION_RECEPTORA']; echo "</td>";
        echo "</tr>";
 }
oci_close($c);
