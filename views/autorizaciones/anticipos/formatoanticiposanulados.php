...
header("Content-Disposition: attachment; filename=Anticipos Anulados - " . "_" . date("d_m_Y") . ".xls");
...
<table cellspacing="0" cellpadding="0" border="1" align="center">
    ...
    $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_ANTICIPOS_AUT.P_OBTENER_REGISTROS_ANULADOS(:V_FECHA_I,:V_FECHA_F,:V_SECCIONAL,:V_RESULT); end;');
