...
<head>
    ...
    <script src="../../../scripts/controllers/contratacion/formatos/formatosupervisiondecontratoController.js"></script>
</head>
<body ng-controller="ControladorIMP" ng-init="Hoja='ANT'">
    <table id="table1" width="100%" style="border: #FFF;">
        ...
        <tr style="font-weight:700;">
            <td colspan="3" style="text-align: center;padding:0% 0%;">{{infoFormato.cab[0].nombre_supervisor_eps}}</td>
        ...
        <tr style="font-weight:700;">
            <td colspan="9" style="text-align: center;padding:0% 0%;">{{infoFormato.cab[0].Contrato}}</td>
        </tr>
        <tr style="font-weight:700;">
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">Proceso 1. Mantenimiento de las condiciones de habilitación y soportes contractuales 15%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_1}}</td>
        </tr>
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">Proceso: 2. Indicadores 20%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_2}}</td>
        </tr>
        <tr style="font-weight:700;">
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">Proceso: 3. Cumplimiento financieros 5%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_3}}</td>
        </tr>
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="1" style="text-align: center;padding:0% 0%;">Criterio </td>
            <td colspan="1" style="text-align: center;padding:0% 0%;">Cumple</td>
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">Proceso: 4. Prestación efectiva de los servicios 20%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_4}}</td>
        </tr>
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="1" style="text-align: center;padding:0% 0%;">Criterio </td>
            <td colspan="1" style="text-align: center;padding:0% 0%;">Cumple</td>
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">Proceso: 5. Satisfacción del usuario 20%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_5}}</td>
        </tr>
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="1" style="text-align: center;padding:0% 0%;">Criterio </td>
            <td colspan="1" style="text-align: center;padding:0% 0%;">Cumple</td>
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">Proceso: 6. Tutelas 5%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_6}}</td>
        </tr>
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="1" style="text-align: center;padding:0% 0%;">Criterio </td>
            <td colspan="1" style="text-align: center;padding:0% 0%;">Cumple</td>
        ...
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="8" style="text-align: left;">proceso: 7. Planes de acción 15%</td>
            <td colspan="1" style="text-align: center;">{{infoResultado[0].P_PROCESO_7 }}</td>
        </tr>
        <tr style="font-weight:700; background-color:#1a2e63;color:white;padding:1% 0%;">
            <td colspan="1" style="text-align: center;padding:0% 0%;">Criterio </td>
            <td colspan="1" style="text-align: center;padding:0% 0%;">Cumple</td>
