        ...
        <td>
              ...
              <td colspan="5" class="text-center text-size8 text-right">
                <div style="display: inline-flex;width: 100%;">
                  ...
                  <div style="width: 55%;">
                    ...
                    <input type="checkbox" id="clase_10" name="clase_10"
                      ng-checked="DATA.union_temporal != '' || DATA.OT == 'S'" onclick="return false;">
                  </div>
                  <!-- <div style="width: 100%;">
          ...
          <div id="minuta_contrato">
            ...
            <div class="minuta_texto">EL PSS se obliga para con la ERP a: 1. Prestar los servicios objeto del presente
              ...
              derivadas del presente contrato y del contenido de la normatividad vigente.
              <span class="minuta_paragrafo">PARÁGRAFO ACLARATORIO.</span> Las obligaciones descritas en la
              presente clausula guardarán relación directa con el objeto y los servicios contratados, es decir, que
              existen obligaciones aplicables y no aplicables al PSS para el cumplimiento del acuerdo de voluntades.
            </div>
            ...
            <div class="minuta_texto">Los servicios están sujetos al régimen de pagos compartidos o copagos y cuotas
              ...
              o no de dichos copagos y cuotas moderadoras en caso de haberlos gestionado, en los tiempos definidos por
              las normas legales con el fin de soportar los procesos de auditoría que haya lugar. El PSS deberá
              registrar en el aplicativo Génesis las cuotas moderadoras y copagos realmente cobrados y adjuntar el
              soporte correspondiente. <span class="minuta_paragrafo">PARÁGRAFO PRIMERO.</span> En el evento y ante la
              imposibilidad de pago por parte del afiliado, el PSS reportará a la ERP dicha situación mediante el
              aplicativo Genesis y consecuentemente procederá al diligenciamiento del formato de no recaudo y/o
              documento institucional homólogo definido por cada PSS para dejar consignado la imposibilidad de pago de
              los usuarios, debe adjuntarse a la factura y sus soportes. Este formato de notificación deberá ir firmado
              por el afiliado y por el funcionario encargado del PSS, con los datos mínimos de identificación y de
              contacto actualizados, como constancia, y en señal del conocimiento previamente informado, sobre la
              aplicación de las cuotas moderadoras y/o copagos a que está sujeto por los servicios prestados. <span
                class="minuta_paragrafo">PARÁGRAFO SEGUNDO.</span> El PSS deberá abstenerse de cobrar a los afiliados
            ...
            <div class="minuta_texto">El PSS se obliga en cumplimiento del presente contrato a la atención de todo lo
              ...
              Anexo 1. <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. ACTUALIZACIÓN DE INDICADORES E
                IMPREVISTOS.</span> En
              ...
              Comercio. <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. NOTIFICACIÓN DE PRESTACIÓN.</span> La
              prestación del servicio, entrega del medicamento o insumo, se deberá realizar
              finalizada la atención del afiliado en un periodo no mayor a tres días posteriores a esta y para los casos
              de medicamentos vitales no disponibles o de preparaciones especiales, entre otros, se realizará en los
              tiempos establecidos en la Resolución 1885 de 2018, Art. 33 o aquella que modifique, adicione o sustituya,
              a través del portal dispuesto para tal fin. Sin dicha validación se dará por no prestado el servicio o
              entregado el medicamento o insumo, lo que impedirá la radicación de la factura.</div>
            ...
            <div class="minuta_texto">El contrato se evaluará de conformidad con el Modelo de Auditoría descrito en el
              ...
              Manual de Auditoría de Calidad de la ERP. <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. MODELO DE
            ...
            <div class="minuta_texto">
              ...
              causales señaladas en esta cláusula, donde deberá informar y justificar el motivo y/o causal invocada para
            ...
            <div class="minuta_texto">El incumplimiento de (2) o más de las obligaciones derivadas de este contrato por
              parte el PSS, genera el
            ...
            <div class="minuta_texto">El PSS mantendrá vigente una Póliza de responsabilidad civil extracontractual para
            ...
            <div class="minuta_texto">Las partes afirman bajo la gravedad del juramento que se entiende prestado con la
              ...
              adicional ante la ERP, que los habilite para obligarse con el valor contratado.</div>
            ...
            <div class="minuta_texto">
              ...
              causas: 1) Cuando se adelante investigación administrativa, disciplinaria, civil o penal o adelantada por
              un
              ...
              cumplimiento de sus obligaciones contractuales, siempre que se informe a la otra parte con una antelación
              no
            ...
            <table id="table_anexos" class="">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">NO</td>
                  <td>Anexo 22. Incentivos pactados</td>
                  <td class="text-center">SI</td>
                </tr>
