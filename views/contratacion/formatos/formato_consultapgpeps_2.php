...
header("Expires: 0");
header("Content-Disposition: attachment; filename=Reporte Avanzado de Actividades PGP " . $F_Inicio . " - " . $F_Fin . ".xls");
...
<table cellspacing="0" cellpadding="0" border="1" align="center">
    ...
    global $request;
    $consulta = oci_parse($c, 'BEGIN PQ_GENESIS_CONTRATACION.P_LISTA_EPS_REGISTRO_PGP_2(:v_ptercero,:v_fecha_inicio,:v_fecha_fin,:v_ptipo_busqueda,
    ...
    foreach  ($datos as $row) {
        ...
        echo "<td>";echo $row->costo_total_prod;echo "</td>";
        echo "</tr>";
    }
