        ...
        <td>
              ...
              <td colspan="5" class="text-center text-right">
                ...
                <div style="display: inline-flex;width: 100%;">
                  <div style="width: 45%;">
                    ...
                    <input type="checkbox" id="modalidad_5" name="modalidad_5" checked="true" onclick="return false;">
                  </div>
                  <div style="width: 55%;">
          ...
          <div id="minuta_contrato">
            ...
            <div class="minuta_texto">
              ...
              <span class="minuta_paragrafo">PARÁGRAFO QUINTO. NOTIFICACIÓN DE PRESTACIÓN. </span>La prestación del servicio, entrega del medicamento o insumo, se deberá realizar finalizada la atención del afiliado en un periodo no mayor a tres días posteriores a esta y para los casos de medicamentos vitales no disponibles o de preparaciones especiales, entre otros, se realizará en los tiempos establecidos en la Resolución 1885 de 2018, Art. 33 o aquella que modifique, adicione o sustituya, a través del portal dispuesto para tal fin. Sin dicha validación se dará por no prestado el servicio o entregado el medicamento o insumo, lo que impedirá la radicación de la factura.X
            </div>
