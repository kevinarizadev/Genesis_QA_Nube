        ...
        <td>
                ...
                <div style="display: inline-flex;width: 100%;">
                  ...
                  <ul style="margin: 0;list-style-type: none;">
                    <li>
                      ...
                      <input type="checkbox" id="tipo_capita_4" name="tipo_capita_4" checked="true" onclick="return false;">
                    </li>
                    <li>
          ...
          <div id="minuta_contrato">
            ...
            <div class="minuta_texto_1 mb">
              ...
              TRANSPORTE, de común acuerdo para la atención de los afiliados, al Sistema
        ...
        <th class="report-header-cell">
          <div class="header-info text-left d-flex">
            ...
            <div class="text-bold7">
              ...
              PRESTACION DE SERVICIOS DE SALUD MEDIANTE LA MODALIDAD DE TRANSPORTE
