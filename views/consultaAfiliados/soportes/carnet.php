...
<html ng-app = "GenesisApp">
	<head>
		...
		<title>Carnet - Regimen Subsidiado</title>
	...
	<body ng-controller="carnetcontroller">
		<div ng-init="obtenerParam()">
			...
			<div id="ips_asignada"><center>{{cabeza.PYP}}</center></div>
			<div id="ips"><center>{{cabeza.IPS}}</center></div>
			<div id="tipo_discapacidad"><center>{{cabeza.DISCAPACIDAD}}</center></div>
			<div id="sexo"><center>{{cabeza.SEXO}}</div>
			<div id="nivel_sisben"><center>{{cabeza.NIVELSISBEN}}</center></div>
			<div id="municipio"><center>{{cabeza.MUNICIPIO}}</center></div>
			<img src="carnet_subsidiado.png" width="950" height="325" /><br><br>
		</div>
	</body>
</html>